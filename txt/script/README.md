...
* [bin/edit-conflicts - Open any files marked as being in confict using EDITOR](/txt/script/edit-conflicts.md)

* [bin/em - Alias for 'emacs -nw'](/txt/script/em.md)
...
* [bin/git-diff-annotate -](/txt/script/git-diff-annotate.md)

* [bin/git-grep-reflog - Find a commit in reflog whose delta contains given regex](/txt/script/git-grep-reflog.md)

* [bin/git-mdiff - Git diff but exclude generated files](/txt/script/git-mdiff.md)

* [bin/git-mod-plot -](/txt/script/git-mod-plot.md)

* [bin/git-praise -](/txt/script/git-praise.md)

* [bin/git-rebase-origin - Rebase current branch onto origin master](/txt/script/git-rebase-origin.md)

* [bin/git-rebase-remote - Rebase current branch onto given `git remote`](/txt/script/git-rebase-remote.md)

* [bin/git-recent-branches - List recent branches that you worked on](/txt/script/git-recent-branches.md)

* [bin/git-rollback-file - Roll back specified files to the previous commit](/txt/script/git-rollback-file.md)

* [bin/git-update-config -](/txt/script/git-update-config.md)

* [bin/gitconfig-setup -](/txt/script/gitconfig-setup.md)

* [bin/grephunk - Patch file filter](/txt/script/grephunk.md)

* [bin/hilite-error - Read input and highlight errors](/txt/script/hilite-error.md)

* [bin/hilite - Inline highlighter](/txt/script/hilite.md)

* [bin/limit-output - Read input and show at most N lines](/txt/script/limit-output.md)

* [bin/lines-to-dots - Read input and print a dot for each input line](/txt/script/lines-to-dots.md)

* [bin/lsfunc - List all functions from all source files](/txt/script/lsfunc.md)
