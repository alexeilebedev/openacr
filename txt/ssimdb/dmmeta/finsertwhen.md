...
|---|---|---|---|---|
|finsertwhen|[dmmeta.Field](/txt/ssimdb/dmmeta/field.md)|[Pkey](/txt/exe/amc/reftype.md#pkey)||Field that gets insert-completion|
|when|[dmmeta.Field](/txt/ssimdb/dmmeta/field.md)|[Pkey](/txt/exe/amc/reftype.md#pkey)||When this flag is also set on the cmdline, use insert-completion for finsertwhen.field|
