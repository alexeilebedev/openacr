...
&#128196; [dmmeta.blkhash - Block hash index, required for fields with reftype Blkhash](/txt/ssimdb/dmmeta/blkhash.md)<br/>
...
&#128196; [dmmeta.ccmdline - tie cmdline to basecmdline](/txt/ssimdb/dmmeta/ccmdline.md)<br/>
...
&#128196; [dmmeta.cjsbltin -](/txt/ssimdb/dmmeta/cjsbltin.md)<br/>
&#128196; [dmmeta.cjson -](/txt/ssimdb/dmmeta/cjson.md)<br/>
&#128196; [dmmeta.ckafka -](/txt/ssimdb/dmmeta/ckafka.md)<br/>
&#128196; [dmmeta.cpbuf -](/txt/ssimdb/dmmeta/cpbuf.md)<br/>
...
&#128196; [dmmeta.cpptype - Ask amc for a fieldwise constructor](/txt/ssimdb/dmmeta/cpptype.md)<br/>
...
&#128196; [dmmeta.fcond - List membership tied to a condition on a field](/txt/ssimdb/dmmeta/fcond.md)<br/>
...
&#128196; [dmmeta.ffunc - User-selected field function; pkey is <field>.<name> where name is a tfunc](/txt/ssimdb/dmmeta/ffunc.md)<br/>
...
&#128196; [dmmeta.finsertwhen - Switch -<flag> to insert-completion mode when <when> flag is also set](/txt/ssimdb/dmmeta/finsertwhen.md)<br/>
...
&#128196; [dmmeta.fpbuf -](/txt/ssimdb/dmmeta/fpbuf.md)<br/>
&#128196; [dmmeta.fpbufcase -](/txt/ssimdb/dmmeta/fpbufcase.md)<br/>
&#128196; [dmmeta.fprefix - Allowed pairing of field-name prefix and reftype](/txt/ssimdb/dmmeta/fprefix.md)<br/>
...
&#128196; [dmmeta.ftrace - Generate counters for a field: allocations, buffer traffic, or step cycles](/txt/ssimdb/dmmeta/ftrace.md)<br/>
...
&#128196; [dmmeta.jsbltin -](/txt/ssimdb/dmmeta/jsbltin.md)<br/>
...
&#128196; [dmmeta.msg - Message ctype layout summary (amc-derived)](/txt/ssimdb/dmmeta/msg.md)<br/>
&#128196; [dmmeta.msgfield - Resolved leaf field layout of a message ctype (amc-derived)](/txt/ssimdb/dmmeta/msgfield.md)<br/>
...
&#128196; [dmmeta.payloadhdr - Header ctype framing messages: typefld/lenfld layout (amc-derived)](/txt/ssimdb/dmmeta/payloadhdr.md)<br/>
&#128196; [dmmeta.pbsyntax - Protobuf syntax variant selecting default-value and presence semantics](/txt/ssimdb/dmmeta/pbsyntax.md)<br/>
