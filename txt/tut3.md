...
acr.insert  dev.gitfile  gitfile:txt/samp_tut3.md
  acr.insert  dev.readme  gitfile:txt/samp_tut3.md             inl:N   sandbox:N   filter:""  comment:""
    acr.insert  dev.readmens  readme:txt/samp_tut3.md  ns:samp_tut3  comment:""
...
acr.insert  dmmeta.ns  ns:samp_tut3  nstype:exe  license:GPL  comment:""
  acr.insert  dev.target  target:samp_tut3  compat:Linux-%.%-%
    ...
    acr.insert  dev.targdep  targdep:samp_tut3.algo_pch  comment:""
...
acr_ed.create_field  field:samp_tut3.FDb.zd_value
samp_tut3.FDb.zd_value
samp_tut3.FDb.value
acr_ed.guess_arg  arg:samp_tut3.Value
report.acr_check  records:***  errors:0
