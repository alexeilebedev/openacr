...
#### algo.ImdbRemoveStrptrMaybeFcn - Function to remove ssim tuple from in-memory database
<a href="#algo-imdbremovestrptrmaybefcn"></a>
...
```c++
tempstr algo::CountToStr(i64 val, bool numeric = false)
```
...
```c++
tempstr algo::HzToStr(u64 val, bool numeric = false)
```
...
i64 algo::ParseCount(algo::strptr str, i64 dflt = 0)
```
...
u64 algo::ParseHz(algo::strptr str, u64 dflt = 0)
```
...
u64 algo::ParseNsec(algo::strptr str, u64 dflt = 0)
```
...
// reads.  No-throw.
u64 algo::ParseSize(algo::strptr str, u64 dflt = 0)
```
...
bool algo::SafeStringToFile(const strptr& str, const strptr& filename, int dfltmode, bool check_same = true)
```
...
bool algo::SaveFile(algo::strptr str, algo::strptr fname, algo::strptr tag, algo::strptr comment, int dfltmode = 0644)
```
...
bool algo::SaveFileFresh(algo::strptr str, algo::strptr fname, algo::strptr tag, algo::strptr comment, int dfltmode = 0644)
```
...
```c++
tempstr algo::SizeToStr(u64 val, bool numeric = false)
```
...
void algo::i64_PrintCount(i64 val, algo::cstring &out, bool numeric = false)
```
...
void algo::retry_curs_Reset(algo::retry_curs &curs, double wait_sec, bool failok = false)
```
...
void algo::strptr_PrintCppQuoted(algo::strptr str, algo::cstring &out, char quote_char, bool multiline = false)
```
...
// unambiguous.
void algo::u64_PrintHz(u64 val, algo::cstring &out, bool numeric = false)
```

```c++
// Format a nanosecond count with ns/us/ms/s suffix (one decimal place).
void algo::u64_PrintNsec(u64 val, algo::cstring &out, bool numeric = false)
```
...
void algo::u64_PrintSize(u64 val, algo::cstring &out, bool numeric = false)
```
