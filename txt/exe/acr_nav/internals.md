...
|[acr_nav.FNavmode](#acr_nav-fnavmode)|[acr_navdb.navmode](/txt/ssimdb/acr_navdb/navmode.md)|FDb.navmode (Lary)|navmode (Lary, by rowid)|ind_navmode (Thash, hash field navmode)|p_cur_mode (Ptr)|
...
|Field|[Type](/txt/ssimdb/dmmeta/ctype.md)|[Reftype](/txt/ssimdb/dmmeta/reftype.md)|Default|Comment|
|---|---|---|---|---|
|acr_nav.Naventry.ctype_name|[algo.cstring](/txt/protocol/algo/cstring.md)|[Val](/txt/exe/amc/reftypes.md#val)||Ctype name|
...
|Comptest|Comment|
|---|---|
|[acr_nav.BatchConfig](/test/atf_comp/acr_nav.BatchConfig)|Batch output for config namespace|
|[acr_nav.BatchSelf](/test/atf_comp/acr_nav.BatchSelf)|Batch output for own namespace|
|[acr_nav.EmptyResult](/test/atf_comp/acr_nav.EmptyResult)|Empty namespace filter|
