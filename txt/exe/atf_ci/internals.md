...
|Source File|Comment|
|---|---|
|[cpp/atf_ci/abt_md.cpp](/cpp/atf_ci/abt_md.cpp)||
...
|[atf_ci.FReadmefile](#atf_ci-freadmefile)|[dev.readmefile](/txt/ssimdb/dev/readmefile.md)|FDb.readmefile (Lary)|readmefile (Lary, by rowid)|
...
|atf_ci.FDb.readmefile|[atf_ci.FReadmefile](/txt/exe/atf_ci/internals.md#atf_ci-freadmefile)|[Lary](/txt/exe/amc/reftypes.md#lary)|||
...
|atf_ci.FDb.called_npm_install|bool|[Val](/txt/exe/amc/reftypes.md#val)|||
...
#### atf_ci.FReadmefile - File containing documentation
<a href="#atf_ci-freadmefile"></a>

#### atf_ci.FReadmefile Fields
<a href="#atf_ci-freadmefile-fields"></a>
|Field|[Type](/txt/ssimdb/dmmeta/ctype.md)|[Reftype](/txt/ssimdb/dmmeta/reftype.md)|Default|Comment|
|---|---|---|---|---|
|atf_ci.FReadmefile.base|[dev.Readmefile](/txt/ssimdb/dev/readmefile.md)|[Base](/txt/ssimdb/dev/readmefile.md)|||

#### Struct FReadmefile
<a href="#struct-freadmefile"></a>
*Note:* field ``atf_ci.FReadmefile.base`` has reftype ``base`` so the fields of [dev.Readmefile](/txt/ssimdb/dev/readmefile.md) above are included into the resulting struct.
