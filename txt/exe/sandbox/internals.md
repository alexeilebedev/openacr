...
|sandbox.FDb.script|[algo.cstring](/txt/protocol/algo/cstring.md)|[Val](/txt/exe/amc/reftypes.md#val)||Accumulated shell script|
|sandbox.FDb.R|[algo_lib.Replscope](/txt/lib/algo_lib/README.md#algo_lib-replscope)|[Val](/txt/exe/amc/reftypes.md#val)||Global variable substitution|
...
|sandbox.FSandbox.R|[algo_lib.Replscope](/txt/lib/algo_lib/README.md#algo_lib-replscope)|[Val](/txt/exe/amc/reftypes.md#val)||Variable substitution|
...
The following component tests are defined for `sandbox`.
These can be executed with `atf_comp <comptest> -v`
|Comptest|Comment|
|---|---|
|[sandbox.Anon](/test/atf_comp/sandbox.Anon)|Test anonymous sandbox dry_run|
|[sandbox.Clean](/test/atf_comp/sandbox.Clean)|Test clean with dry_run|
|[sandbox.Command](/test/atf_comp/sandbox.Command)|Test command execution with dry_run|
|[sandbox.Create](/test/atf_comp/sandbox.Create)|Test create with dry_run|
|[sandbox.Del](/test/atf_comp/sandbox.Del)|Test delete with dry_run|
|[sandbox.Diff](/test/atf_comp/sandbox.Diff)|Test diff flag with dry_run|
|[sandbox.Gc](/test/atf_comp/sandbox.Gc)|Test gc flag with dry_run|
|[sandbox.List](/test/atf_comp/sandbox.List)|Test list with stdin sandbox data|
|[sandbox.Pull](/test/atf_comp/sandbox.Pull)|Test pull flag with dry_run|
|[sandbox.Reset](/test/atf_comp/sandbox.Reset)|Test reset with dry_run|
|[sandbox.StdinMulti](/test/atf_comp/sandbox.StdinMulti)|Test multi-line stdin script|
