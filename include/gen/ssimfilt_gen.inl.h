...
inline void ssimfilt::FUnstablefld_Init(ssimfilt::FUnstablefld& parent) {
    parent.ind_unstablefld_next = (ssimfilt::FUnstablefld*)-1; // (ssimfilt.FDb.ind_unstablefld) not-in-hash
    parent.ind_unstablefld_hashval = 0; // stored hash value
}
