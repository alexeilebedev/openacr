...
// Return max. number of items in the array
inline i64 command::fields_Max(command::gcli& parent) {
    (void)parent;
...
// Return number of items in the array
inline i64 command::fields_N(const command::gcli& parent) {
    return parent.fields_n;
}

// --- command.gcli.fields.Reserve
// Make sure N *more* elements will fit in array. Process dies if out of memory
inline void command::fields_Reserve(command::gcli& parent, i64 n) {
    u64 new_n = parent.fields_n + n;
