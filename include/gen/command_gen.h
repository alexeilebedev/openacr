...
enum command_FieldIdEnum {                             // command.FieldId.value
    ...
    ,command_FieldId_linelim                    = 246
    ,command_FieldId_strayfile                  = 247
    ,command_FieldId_badchar                    = 248
    ,command_FieldId_badline                    = 249
    ,command_FieldId_expand                     = 250
    ,command_FieldId_ignoreQuote                = 251
    ,command_FieldId_maxpacket                  = 252
    ,command_FieldId_db                         = 253
    ,command_FieldId_createdb                   = 254
    ,command_FieldId_typetag                    = 255
    ,command_FieldId_match                      = 256
    ,command_FieldId_format                     = 257
    ,command_FieldId_tocamelcase                = 258
    ,command_FieldId_tolowerunder               = 259
    ,command_FieldId_pathcomp                   = 260
    ,command_FieldId_fname                      = 261
    ,command_FieldId_outseparator               = 262
    ,command_FieldId_header                     = 263
    ,command_FieldId_prefer_signed              = 264
    ,command_FieldId_value                      = 265
};

enum { command_FieldIdEnum_N = 266 };
