...
enum command_FieldIdEnum {                             // command.FieldId.value
    ...
    ,command_FieldId_query                      = 25
    ,command_FieldId_where                      = 26
    ...
    ,command_FieldId_t                          = 49
    ,command_FieldId_rowid                      = 50
    ,command_FieldId_cmt                        = 51
    ,command_FieldId_print                      = 52
    ,command_FieldId_cmd                        = 53
    ,command_FieldId_field                      = 54
    ,command_FieldId_regxof                     = 55
    ,command_FieldId_meta                       = 56
    ,command_FieldId_data                       = 57
    ,command_FieldId_line                       = 58
    ,command_FieldId_point                      = 59
    ,command_FieldId_type                       = 60
    ,command_FieldId_debug_log                  = 61
    ,command_FieldId_create                     = 62
    ,command_FieldId_finput                     = 63
    ,command_FieldId_foutput                    = 64
    ,command_FieldId_srcfile                    = 65
    ,command_FieldId_gstatic                    = 66
    ,command_FieldId_indexed                    = 67
    ,command_FieldId_nstype                     = 68
    ,command_FieldId_ctype                      = 69
    ,command_FieldId_pooltype                   = 70
    ,command_FieldId_ssimfile                   = 71
    ,command_FieldId_subset                     = 72
    ,command_FieldId_subset2                    = 73
    ,command_FieldId_separator                  = 74
    ,command_FieldId_arg                        = 75
    ,command_FieldId_dflt                       = 76
    ,command_FieldId_anon                       = 77
    ,command_FieldId_bigend                     = 78
    ,command_FieldId_cascdel                    = 79
    ,command_FieldId_before                     = 80
    ,command_FieldId_substr                     = 81
    ,command_FieldId_srcfield                   = 82
    ,command_FieldId_fstep                      = 83
    ,command_FieldId_inscond                    = 84
    ,command_FieldId_reftype                    = 85
    ,command_FieldId_hashfld                    = 86
    ,command_FieldId_sortfld                    = 87
    ,command_FieldId_unittest                   = 88
    ,command_FieldId_citest                     = 89
    ,command_FieldId_cppfunc                    = 90
    ,command_FieldId_via                        = 91
    ,command_FieldId_comment                    = 92
    ,command_FieldId_sandbox                    = 93
    ,command_FieldId_test                       = 94
    ,command_FieldId_showcpp                    = 95
    ,command_FieldId_msgtype                    = 96
    ,command_FieldId_anonfld                    = 97
    ,command_FieldId_ns                         = 98
    ,command_FieldId_sigcheck                   = 99
    ,command_FieldId_data_dir                   = 100
    ,command_FieldId_related                    = 101
    ,command_FieldId_notssimfile                = 102
    ,command_FieldId_checkable                  = 103
    ,command_FieldId_nsdb                       = 104
    ,command_FieldId_fkey                       = 105
    ,command_FieldId_start                      = 106
    ,command_FieldId_stop                       = 107
    ,command_FieldId_abort                      = 108
    ,command_FieldId_shell                      = 109
    ,command_FieldId_serv                       = 110
    ,command_FieldId_in_dir                     = 111
    ,command_FieldId_proto                      = 112
    ,command_FieldId_trace                      = 113
    ,command_FieldId_fconst                     = 114
    ,command_FieldId_gconst                     = 115
    ,command_FieldId_key                        = 116
    ,command_FieldId_include                    = 117
    ,command_FieldId_dot                        = 118
    ,command_FieldId_xns                        = 119
    ,command_FieldId_noinput                    = 120
    ,command_FieldId_render                     = 121
    ,command_FieldId_id                         = 122
    ,command_FieldId_file_prefix                = 123
    ,command_FieldId_nchild                     = 124
    ,command_FieldId_blocking                   = 125
    ,command_FieldId_nmsg                       = 126
    ,command_FieldId_timeout                    = 127
    ,command_FieldId_recvdelay_ns               = 128
    ,command_FieldId_senddelay_ns               = 129
    ,command_FieldId_msgsize_min                = 130
    ,command_FieldId_msgsize_max                = 131
    ,command_FieldId_bufsize                    = 132
    ,command_FieldId_recvdelay                  = 133
    ,command_FieldId_amctest                    = 134
    ,command_FieldId_dofork                     = 135
    ,command_FieldId_q                          = 136
    ,command_FieldId_cijob                      = 137
    ,command_FieldId_capture                    = 138
    ,command_FieldId_exec                       = 139
    ,command_FieldId_astr                       = 140
    ,command_FieldId_anum                       = 141
    ,command_FieldId_adbl                       = 142
    ,command_FieldId_aflag                      = 143
    ,command_FieldId_str                        = 144
    ,command_FieldId_num                        = 145
    ,command_FieldId_dbl                        = 146
    ,command_FieldId_flag                       = 147
    ,command_FieldId_dstr                       = 148
    ,command_FieldId_dnum                       = 149
    ,command_FieldId_ddbl                       = 150
    ,command_FieldId_dflag                      = 151
    ,command_FieldId_mstr                       = 152
    ,command_FieldId_mnum                       = 153
    ,command_FieldId_mdbl                       = 154
    ,command_FieldId_amnum                      = 155
    ,command_FieldId_cconst                     = 156
    ,command_FieldId_dregx                      = 157
    ,command_FieldId_dpkey                      = 158
    ,command_FieldId_comptest                   = 159
    ,command_FieldId_mdbg                       = 160
    ,command_FieldId_run                        = 161
    ,command_FieldId_printinput                 = 162
    ,command_FieldId_normalize                  = 163
    ,command_FieldId_covcapture                 = 164
    ,command_FieldId_covcheck                   = 165
    ,command_FieldId_compdir                    = 166
    ,command_FieldId_check_untracked            = 167
    ,command_FieldId_memcheck                   = 168
    ,command_FieldId_callgrind                  = 169
    ,command_FieldId_stream                     = 170
    ,command_FieldId_i                          = 171
    ,command_FieldId_b                          = 172
    ,command_FieldId_covdir                     = 173
    ,command_FieldId_logfile                    = 174
    ,command_FieldId_runcmd                     = 175
    ,command_FieldId_exclude                    = 176
    ,command_FieldId_mergepath                  = 177
    ,command_FieldId_gcov                       = 178
    ,command_FieldId_ssim                       = 179
    ,command_FieldId_xmlpretty                  = 180
    ,command_FieldId_summary                    = 181
    ,command_FieldId_reprofile                  = 182
    ,command_FieldId_args                       = 183
    ,command_FieldId_inputfile                  = 184
    ,command_FieldId_fuzzstrat                  = 185
    ,command_FieldId_seed                       = 186
    ,command_FieldId_testprob                   = 187
    ,command_FieldId_gtblacttst                 = 188
    ,command_FieldId_mr                         = 189
    ,command_FieldId_note                       = 190
    ,command_FieldId_skip_init                  = 191
    ,command_FieldId_skip_git_init              = 192
    ,command_FieldId_ncmd                       = 193
    ,command_FieldId_nofork                     = 194
    ,command_FieldId_perf_secs                  = 195
    ,command_FieldId_pertest_timeout            = 196
    ,command_FieldId_selector                   = 197
    ,command_FieldId_fields                     = 198
    ,command_FieldId_accept                     = 199
    ,command_FieldId_update                     = 200
    ,command_FieldId_approve                    = 201
    ,command_FieldId_needs_work                 = 202
    ,command_FieldId_authdir                    = 203
    ,command_FieldId_gitdir                     = 204
    ,command_FieldId_show_gitlab_system_notes   = 205
    ,command_FieldId_complooo                   = 206
    ,command_FieldId_attach                     = 207
    ,command_FieldId_catchthrow                 = 208
    ,command_FieldId_tui                        = 209
    ,command_FieldId_bcmd                       = 210
    ,command_FieldId_emacs                      = 211
    ,command_FieldId_manywin                    = 212
    ,command_FieldId_follow_child               = 213
    ,command_FieldId_py                         = 214
    ,command_FieldId_writessimfile              = 215
    ,command_FieldId_url                        = 216
    ,command_FieldId_tables                     = 217
    ,command_FieldId_nologo                     = 218
    ,command_FieldId_baddbok                    = 219
    ,command_FieldId_move                       = 220
    ,command_FieldId_dedup                      = 221
    ,command_FieldId_commit                     = 222
    ,command_FieldId_undo                       = 223
    ,command_FieldId_hash                       = 224
    ,command_FieldId_name                       = 225
    ,command_FieldId_reset                      = 226
    ,command_FieldId_gc                         = 227
    ,command_FieldId_diff                       = 228
    ,command_FieldId_files                      = 229
    ,command_FieldId_targsrc                    = 230
    ,command_FieldId_body                       = 231
    ,command_FieldId_func                       = 232
    ,command_FieldId_nextfile                   = 233
    ,command_FieldId_other                      = 234
    ,command_FieldId_updateproto                = 235
    ,command_FieldId_listfunc                   = 236
    ,command_FieldId_iffy                       = 237
    ,command_FieldId_gen                        = 238
    ,command_FieldId_showloc                    = 239
    ,command_FieldId_showstatic                 = 240
    ,command_FieldId_showsortkey                = 241
    ,command_FieldId_sortname                   = 242
    ,command_FieldId_baddecl                    = 243
    ,command_FieldId_indent                     = 244
    ,command_FieldId_update_copyright           = 245
    ,command_FieldId_scriptfile                 = 246
    ,command_FieldId_linelim                    = 247
    ,command_FieldId_strayfile                  = 248
    ,command_FieldId_badchar                    = 249
    ,command_FieldId_badline                    = 250
    ,command_FieldId_expand                     = 251
    ,command_FieldId_ignoreQuote                = 252
    ,command_FieldId_maxpacket                  = 253
    ,command_FieldId_db                         = 254
    ,command_FieldId_createdb                   = 255
    ,command_FieldId_typetag                    = 256
    ,command_FieldId_match                      = 257
    ,command_FieldId_format                     = 258
    ,command_FieldId_tocamelcase                = 259
    ,command_FieldId_tolowerunder               = 260
    ,command_FieldId_pathcomp                   = 261
    ,command_FieldId_fname                      = 262
    ,command_FieldId_outseparator               = 263
    ,command_FieldId_header                     = 264
    ,command_FieldId_prefer_signed              = 265
    ,command_FieldId_value                      = 266
};

enum { command_FieldIdEnum_N = 267 };
...
// --- command.abt_md_proc
struct abt_md_proc { // command.abt_md_proc: Subprocess: 
