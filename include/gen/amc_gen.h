...
enum amc_TableIdEnum {                        // amc.TableId.value
    ...
    ,amc_TableId_dmmeta_lenfld         = 61   // dmmeta.lenfld -> amc.FLenfld
    ,amc_TableId_dmmeta_Listtype       = 62   // dmmeta.Listtype -> amc.FListtype
    ,amc_TableId_dmmeta_listtype       = 62   // dmmeta.listtype -> amc.FListtype
    ,amc_TableId_dmmeta_Llist          = 63   // dmmeta.Llist -> amc.FLlist
    ,amc_TableId_dmmeta_llist          = 63   // dmmeta.llist -> amc.FLlist
    ,amc_TableId_dmmeta_Main           = 64   // dmmeta.Main -> amc.FMain
    ,amc_TableId_dmmeta_main           = 64   // dmmeta.main -> amc.FMain
    ,amc_TableId_dmmeta_Msgtype        = 65   // dmmeta.Msgtype -> amc.FMsgtype
    ,amc_TableId_dmmeta_msgtype        = 65   // dmmeta.msgtype -> amc.FMsgtype
    ,amc_TableId_dmmeta_Nocascdel      = 66   // dmmeta.Nocascdel -> amc.FNocascdel
    ,amc_TableId_dmmeta_nocascdel      = 66   // dmmeta.nocascdel -> amc.FNocascdel
    ,amc_TableId_dmmeta_Nossimfile     = 67   // dmmeta.Nossimfile -> amc.FNossimfile
    ,amc_TableId_dmmeta_nossimfile     = 67   // dmmeta.nossimfile -> amc.FNossimfile
