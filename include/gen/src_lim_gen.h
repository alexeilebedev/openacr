...
src_lim::FInclude*   include_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
...
// Return true if index is empty
bool                 linelim_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
src_lim::FLinelim*   linelim_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Look up row by row id. Return NULL if out of range
src_lim::FTargsrc*   targsrc_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Look up row by row id. Return NULL if out of range
src_lim::FGitfile*   gitfile_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 zd_include_EmptyQ(src_lim::FGitfile& gitfile) __attribute__((__warn_unused_result__, nothrow));
