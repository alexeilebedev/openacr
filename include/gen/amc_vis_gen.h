...
// Look up row by row id. Return NULL if out of range
amc_vis::FCtype*     ctype_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
...
// Look up row by row id. Return NULL if out of range
amc_vis::FField*     field_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 node_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
amc_vis::FNode*      node_Find(i32 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 link_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
amc_vis::Link*       link_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 linkdep_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
amc_vis::Linkdep*    linkdep_Find(i32 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Look up row by row id. Return NULL if out of range
amc_vis::FReftype*   reftype_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 nodedep_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
amc_vis::FNodedep*   nodedep_Find(i32 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 outrow_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
amc_vis::Outrow*     outrow_Find(i32 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Look up row by row id. Return NULL if out of range
amc_vis::FFinput*    finput_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// Return true if index is empty
bool                 zd_nodedep_out_EmptyQ(amc_vis::FNode& node) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zd_nodedep_in_EmptyQ(amc_vis::FNode& node) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zd_link_out_EmptyQ(amc_vis::FNode& node) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zd_link_in_EmptyQ(amc_vis::FNode& node) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zd_linkdep_out_EmptyQ(amc_vis::Link& link) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zd_linkdep_in_EmptyQ(amc_vis::Link& link) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
private:
    ...
    Outrow();
    ~Outrow();
    // reftype of amc_vis.Outrow.text prohibits copy
