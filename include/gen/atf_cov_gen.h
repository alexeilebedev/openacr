...
bool                 covline_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
atf_cov::FCovline*   covline_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
...
atf_cov::FCovline&   covline_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
atf_cov::FTarget*    target_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FTarget&    target_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
atf_cov::FTargsrc*   targsrc_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FTargsrc&   targsrc_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
atf_cov::FGitfile*   gitfile_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FGitfile&   gitfile_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 covtarget_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
atf_cov::FCovtarget* covtarget_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FCovtarget& covtarget_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 covfile_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
atf_cov::FCovfile*   covfile_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FCovfile&   covfile_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 tgtcov_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
atf_cov::FTgtcov*    tgtcov_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
atf_cov::FTgtcov&    tgtcov_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
