...
inline void ssim2csv::FExpand_Init(ssim2csv::FExpand& parent) {
    parent.ind_expand_next = (ssim2csv::FExpand*)-1; // (ssim2csv.FDb.ind_expand) not-in-hash
    parent.ind_expand_hashval = 0; // stored hash value
}
...
// Set all fields to initial values.
inline void ssim2csv::FOutfile_Init(ssim2csv::FOutfile& parent) {
    parent.ind_outfile_next = (ssim2csv::FOutfile*)-1; // (ssim2csv.FDb.ind_outfile) not-in-hash
    parent.ind_outfile_hashval = 0; // stored hash value
}
