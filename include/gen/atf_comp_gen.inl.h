...
inline bool atf_comp::c_targs_InsertMaybe(atf_comp::FComptest& comptest, atf_comp::FTargs& row) throw() {
...
inline void atf_comp::c_targs_Remove(atf_comp::FComptest& comptest, atf_comp::FTargs& row) throw() {
    atf_comp::FTargs *ptr = comptest.c_targs;
    if (LIKELY(ptr == &row)) {
...
// Insert row into pointer index. Return final membership status.
inline bool atf_comp::c_tfilt_InsertMaybe(atf_comp::FComptest& comptest, atf_comp::FTfilt& row) throw() {
...
// Remove element from index. If element is not in index, do nothing.
inline void atf_comp::c_tfilt_Remove(atf_comp::FComptest& comptest, atf_comp::FTfilt& row) throw() {
    atf_comp::FTfilt *ptr = comptest.c_tfilt;
    if (LIKELY(ptr == &row)) {
...
inline bool atf_comp::zd_tmsg_EmptyQ(atf_comp::FComptest& comptest) throw() {
    return comptest.zd_tmsg_head == NULL;
}

// --- atf_comp.FComptest.zd_tmsg.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FTmsg* atf_comp::zd_tmsg_First(atf_comp::FComptest& comptest) throw() {
...
inline bool atf_comp::zd_tmsg_InLlistQ(atf_comp::FTmsg& row) throw() {
    bool result = false;
...
inline atf_comp::FTmsg* atf_comp::zd_tmsg_Last(atf_comp::FComptest& comptest) throw() {
    atf_comp::FTmsg *row = NULL;
...
inline i32 atf_comp::zd_tmsg_N(const atf_comp::FComptest& comptest) throw() {
    return comptest.zd_tmsg_n;
}

// --- atf_comp.FComptest.zd_tmsg.Next
// Return pointer to next element in the list
inline atf_comp::FTmsg* atf_comp::zd_tmsg_Next(atf_comp::FTmsg &row) throw() {
    return row.zd_tmsg_next;
}

// --- atf_comp.FComptest.zd_tmsg.Prev
// Return pointer to previous element in the list
inline atf_comp::FTmsg* atf_comp::zd_tmsg_Prev(atf_comp::FTmsg &row) throw() {
    return row.zd_tmsg_prev;
}

// --- atf_comp.FComptest.zd_tmsg.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FTmsg& atf_comp::zd_tmsg_qLast(atf_comp::FComptest& comptest) throw() {
    atf_comp::FTmsg *row = NULL;
    row = comptest.zd_tmsg_tail;
    return *row;
}
...
inline void atf_comp::comptest_zd_tmsg_curs_Reset(comptest_zd_tmsg_curs &curs, atf_comp::FComptest &parent) throw() {
    curs.row = parent.zd_tmsg_head;
}

// --- atf_comp.FComptest.zd_tmsg_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::comptest_zd_tmsg_curs_ValidQ(comptest_zd_tmsg_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FComptest.zd_tmsg_curs.Next
// proceed to next item
inline void atf_comp::comptest_zd_tmsg_curs_Next(comptest_zd_tmsg_curs &curs) throw() {
...
// item access
inline atf_comp::FTmsg& atf_comp::comptest_zd_tmsg_curs_Access(comptest_zd_tmsg_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FComptest..Ctor
inline  atf_comp::FComptest::FComptest() throw() {
...
// --- atf_comp.trace..Ctor
inline  atf_comp::trace::trace() throw() {
}

// --- atf_comp.FDb.comptest.EmptyQ
// Return true if index is empty
inline bool atf_comp::comptest_EmptyQ() throw() {
    return _db.comptest_n == 0;
}

// --- atf_comp.FDb.comptest.Find
// Look up row by row id. Return NULL if out of range
inline atf_comp::FComptest* atf_comp::comptest_Find(u64 t) throw() {
...
inline atf_comp::FComptest* atf_comp::comptest_Last() throw() {
    return comptest_Find(u64(_db.comptest_n-1));
}

// --- atf_comp.FDb.comptest.N
// Return number of items in the pool
inline i32 atf_comp::comptest_N() throw() {
    return _db.comptest_n;
}

// --- atf_comp.FDb.comptest.qFind
// 'quick' Access row by row id. No bounds checking.
inline atf_comp::FComptest& atf_comp::comptest_qFind(u64 t) throw() {
    u64 x = t + 1;
    u64 bsr   = algo::u64_BitScanReverse(x);
    u64 base  = u64(1)<<bsr;
    u64 index = x-base;
...
inline bool atf_comp::ind_comptest_EmptyQ() throw() {
    return _db.ind_comptest_n == 0;
}

// --- atf_comp.FDb.ind_comptest.N
// Return number of items in the hash
inline i32 atf_comp::ind_comptest_N() throw() {
    return _db.ind_comptest_n;
}

// --- atf_comp.FDb.zd_sel_comptest.EmptyQ
// Return true if index is empty
inline bool atf_comp::zd_sel_comptest_EmptyQ() throw() {
    return _db.zd_sel_comptest_head == NULL;
}

// --- atf_comp.FDb.zd_sel_comptest.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FComptest* atf_comp::zd_sel_comptest_First() throw() {
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_sel_comptest_InLlistQ(atf_comp::FComptest& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FComptest* atf_comp::zd_sel_comptest_Last() throw() {
    atf_comp::FComptest *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_sel_comptest_N() throw() {
    return _db.zd_sel_comptest_n;
}

// --- atf_comp.FDb.zd_sel_comptest.Next
// Return pointer to next element in the list
inline atf_comp::FComptest* atf_comp::zd_sel_comptest_Next(atf_comp::FComptest &row) throw() {
    return row.zd_sel_comptest_next;
}

// --- atf_comp.FDb.zd_sel_comptest.Prev
// Return pointer to previous element in the list
inline atf_comp::FComptest* atf_comp::zd_sel_comptest_Prev(atf_comp::FComptest &row) throw() {
    return row.zd_sel_comptest_prev;
}

// --- atf_comp.FDb.zd_sel_comptest.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FComptest& atf_comp::zd_sel_comptest_qLast() throw() {
    atf_comp::FComptest *row = NULL;
    row = _db.zd_sel_comptest_tail;
    return *row;
}
...
// Return true if index is empty
inline bool atf_comp::zd_run_comptest_EmptyQ() throw() {
    return _db.zd_run_comptest_head == NULL;
}

// --- atf_comp.FDb.zd_run_comptest.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FComptest* atf_comp::zd_run_comptest_First() throw() {
    atf_comp::FComptest *row = NULL;
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_run_comptest_InLlistQ(atf_comp::FComptest& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FComptest* atf_comp::zd_run_comptest_Last() throw() {
    atf_comp::FComptest *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_run_comptest_N() throw() {
    return _db.zd_run_comptest_n;
}

// --- atf_comp.FDb.zd_run_comptest.Next
// Return pointer to next element in the list
inline atf_comp::FComptest* atf_comp::zd_run_comptest_Next(atf_comp::FComptest &row) throw() {
    return row.zd_run_comptest_next;
}

// --- atf_comp.FDb.zd_run_comptest.Prev
// Return pointer to previous element in the list
inline atf_comp::FComptest* atf_comp::zd_run_comptest_Prev(atf_comp::FComptest &row) throw() {
    return row.zd_run_comptest_prev;
}

// --- atf_comp.FDb.zd_run_comptest.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FComptest& atf_comp::zd_run_comptest_qLast() throw() {
    atf_comp::FComptest *row = NULL;
    row = _db.zd_run_comptest_tail;
    return *row;
}
...
// Return true if index is empty
inline bool atf_comp::zd_out_tmsg_EmptyQ() throw() {
    return _db.zd_out_tmsg_head == NULL;
}

// --- atf_comp.FDb.zd_out_tmsg.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FTmsg* atf_comp::zd_out_tmsg_First() throw() {
    atf_comp::FTmsg *row = NULL;
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_out_tmsg_InLlistQ(atf_comp::FTmsg& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FTmsg* atf_comp::zd_out_tmsg_Last() throw() {
    atf_comp::FTmsg *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_out_tmsg_N() throw() {
    return _db.zd_out_tmsg_n;
}

// --- atf_comp.FDb.zd_out_tmsg.Next
// Return pointer to next element in the list
inline atf_comp::FTmsg* atf_comp::zd_out_tmsg_Next(atf_comp::FTmsg &row) throw() {
    return row.zd_out_tmsg_next;
}

// --- atf_comp.FDb.zd_out_tmsg.Prev
// Return pointer to previous element in the list
inline atf_comp::FTmsg* atf_comp::zd_out_tmsg_Prev(atf_comp::FTmsg &row) throw() {
    return row.zd_out_tmsg_prev;
}

// --- atf_comp.FDb.zd_out_tmsg.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FTmsg& atf_comp::zd_out_tmsg_qLast() throw() {
    atf_comp::FTmsg *row = NULL;
    row = _db.zd_out_tmsg_tail;
    return *row;
}
...
// Return true if index is empty
inline bool atf_comp::zd_out_comptest_EmptyQ() throw() {
    return _db.zd_out_comptest_head == NULL;
}

// --- atf_comp.FDb.zd_out_comptest.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FComptest* atf_comp::zd_out_comptest_First() throw() {
    atf_comp::FComptest *row = NULL;
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_out_comptest_InLlistQ(atf_comp::FComptest& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FComptest* atf_comp::zd_out_comptest_Last() throw() {
    atf_comp::FComptest *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_out_comptest_N() throw() {
    return _db.zd_out_comptest_n;
}

// --- atf_comp.FDb.zd_out_comptest.Next
// Return pointer to next element in the list
inline atf_comp::FComptest* atf_comp::zd_out_comptest_Next(atf_comp::FComptest &row) throw() {
    return row.zd_out_comptest_next;
}

// --- atf_comp.FDb.zd_out_comptest.Prev
// Return pointer to previous element in the list
inline atf_comp::FComptest* atf_comp::zd_out_comptest_Prev(atf_comp::FComptest &row) throw() {
    return row.zd_out_comptest_prev;
}

// --- atf_comp.FDb.zd_out_comptest.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FComptest& atf_comp::zd_out_comptest_qLast() throw() {
    atf_comp::FComptest *row = NULL;
    row = _db.zd_out_comptest_tail;
    return *row;
}
...
// Return true if index is empty
inline bool atf_comp::zd_out_tfilt_EmptyQ() throw() {
    return _db.zd_out_tfilt_head == NULL;
}

// --- atf_comp.FDb.zd_out_tfilt.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FTfilt* atf_comp::zd_out_tfilt_First() throw() {
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_out_tfilt_InLlistQ(atf_comp::FTfilt& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FTfilt* atf_comp::zd_out_tfilt_Last() throw() {
    atf_comp::FTfilt *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_out_tfilt_N() throw() {
    return _db.zd_out_tfilt_n;
}

// --- atf_comp.FDb.zd_out_tfilt.Next
// Return pointer to next element in the list
inline atf_comp::FTfilt* atf_comp::zd_out_tfilt_Next(atf_comp::FTfilt &row) throw() {
    return row.zd_out_tfilt_next;
}

// --- atf_comp.FDb.zd_out_tfilt.Prev
// Return pointer to previous element in the list
inline atf_comp::FTfilt* atf_comp::zd_out_tfilt_Prev(atf_comp::FTfilt &row) throw() {
    return row.zd_out_tfilt_prev;
}

// --- atf_comp.FDb.zd_out_tfilt.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FTfilt& atf_comp::zd_out_tfilt_qLast() throw() {
    atf_comp::FTfilt *row = NULL;
    row = _db.zd_out_tfilt_tail;
    return *row;
}
...
// Return true if index is empty
inline bool atf_comp::zd_out_targs_EmptyQ() throw() {
    return _db.zd_out_targs_head == NULL;
}

// --- atf_comp.FDb.zd_out_targs.First
// If index empty, return NULL. Otherwise return pointer to first element in index
inline atf_comp::FTargs* atf_comp::zd_out_targs_First() throw() {
...
// Return true if row is in the linked list, false otherwise
inline bool atf_comp::zd_out_targs_InLlistQ(atf_comp::FTargs& row) throw() {
    bool result = false;
...
// If index empty, return NULL. Otherwise return pointer to last element in index
inline atf_comp::FTargs* atf_comp::zd_out_targs_Last() throw() {
    atf_comp::FTargs *row = NULL;
...
// Return number of items in the linked list
inline i32 atf_comp::zd_out_targs_N() throw() {
    return _db.zd_out_targs_n;
}

// --- atf_comp.FDb.zd_out_targs.Next
// Return pointer to next element in the list
inline atf_comp::FTargs* atf_comp::zd_out_targs_Next(atf_comp::FTargs &row) throw() {
    return row.zd_out_targs_next;
}

// --- atf_comp.FDb.zd_out_targs.Prev
// Return pointer to previous element in the list
inline atf_comp::FTargs* atf_comp::zd_out_targs_Prev(atf_comp::FTargs &row) throw() {
    return row.zd_out_targs_prev;
}

// --- atf_comp.FDb.zd_out_targs.qLast
// Return reference to last element in the index. No bounds checking.
inline atf_comp::FTargs& atf_comp::zd_out_targs_qLast() throw() {
    atf_comp::FTargs *row = NULL;
    row = _db.zd_out_targs_tail;
    return *row;
}
...
// cursor points to valid item
inline void atf_comp::_db_comptest_curs_Reset(_db_comptest_curs &curs, atf_comp::FDb &parent) throw() {
    curs.parent = &parent;
    curs.index = 0;
}
...
// cursor points to valid item
inline bool atf_comp::_db_comptest_curs_ValidQ(_db_comptest_curs &curs) throw() {
    return curs.index < _db.comptest_n;
}

// --- atf_comp.FDb.comptest_curs.Next
// proceed to next item
inline void atf_comp::_db_comptest_curs_Next(_db_comptest_curs &curs) throw() {
    curs.index++;
}

// --- atf_comp.FDb.comptest_curs.Access
// item access
inline atf_comp::FComptest& atf_comp::_db_comptest_curs_Access(_db_comptest_curs &curs) throw() {
    return comptest_qFind(u64(curs.index));
}

// --- atf_comp.FDb.zd_sel_comptest_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_sel_comptest_curs_Reset(_db_zd_sel_comptest_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_sel_comptest_head;
}

// --- atf_comp.FDb.zd_sel_comptest_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_sel_comptest_curs_ValidQ(_db_zd_sel_comptest_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_sel_comptest_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_sel_comptest_curs_Next(_db_zd_sel_comptest_curs &curs) throw() {
...
// item access
inline atf_comp::FComptest& atf_comp::_db_zd_sel_comptest_curs_Access(_db_zd_sel_comptest_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FDb.zd_run_comptest_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_run_comptest_curs_Reset(_db_zd_run_comptest_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_run_comptest_head;
}

// --- atf_comp.FDb.zd_run_comptest_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_run_comptest_curs_ValidQ(_db_zd_run_comptest_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_run_comptest_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_run_comptest_curs_Next(_db_zd_run_comptest_curs &curs) throw() {
...
// item access
inline atf_comp::FComptest& atf_comp::_db_zd_run_comptest_curs_Access(_db_zd_run_comptest_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FDb.zd_out_tmsg_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_out_tmsg_curs_Reset(_db_zd_out_tmsg_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_out_tmsg_head;
}

// --- atf_comp.FDb.zd_out_tmsg_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_out_tmsg_curs_ValidQ(_db_zd_out_tmsg_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_out_tmsg_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_out_tmsg_curs_Next(_db_zd_out_tmsg_curs &curs) throw() {
...
// item access
inline atf_comp::FTmsg& atf_comp::_db_zd_out_tmsg_curs_Access(_db_zd_out_tmsg_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FDb.zd_out_comptest_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_out_comptest_curs_Reset(_db_zd_out_comptest_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_out_comptest_head;
}

// --- atf_comp.FDb.zd_out_comptest_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_out_comptest_curs_ValidQ(_db_zd_out_comptest_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_out_comptest_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_out_comptest_curs_Next(_db_zd_out_comptest_curs &curs) throw() {
...
// item access
inline atf_comp::FComptest& atf_comp::_db_zd_out_comptest_curs_Access(_db_zd_out_comptest_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FDb.zd_out_tfilt_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_out_tfilt_curs_Reset(_db_zd_out_tfilt_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_out_tfilt_head;
}

// --- atf_comp.FDb.zd_out_tfilt_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_out_tfilt_curs_ValidQ(_db_zd_out_tfilt_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_out_tfilt_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_out_tfilt_curs_Next(_db_zd_out_tfilt_curs &curs) throw() {
...
// item access
inline atf_comp::FTfilt& atf_comp::_db_zd_out_tfilt_curs_Access(_db_zd_out_tfilt_curs &curs) throw() {
    return *curs.row;
}

// --- atf_comp.FDb.zd_out_targs_curs.Reset
// cursor points to valid item
inline void atf_comp::_db_zd_out_targs_curs_Reset(_db_zd_out_targs_curs &curs, atf_comp::FDb &parent) throw() {
    curs.row = parent.zd_out_targs_head;
}

// --- atf_comp.FDb.zd_out_targs_curs.ValidQ
// cursor points to valid item
inline bool atf_comp::_db_zd_out_targs_curs_ValidQ(_db_zd_out_targs_curs &curs) throw() {
    return curs.row != NULL;
}

// --- atf_comp.FDb.zd_out_targs_curs.Next
// proceed to next item
inline void atf_comp::_db_zd_out_targs_curs_Next(_db_zd_out_targs_curs &curs) throw() {
...
// item access
inline atf_comp::FTargs& atf_comp::_db_zd_out_targs_curs_Access(_db_zd_out_targs_curs &curs) throw() {
    return *curs.row;
}
...
inline  atf_comp::FTargs::FTargs() throw() {
...
inline  atf_comp::FTfilt::FTfilt() throw() {
...
// --- atf_comp.FTmsg..Ctor
inline  atf_comp::FTmsg::FTmsg() throw() {
...
inline atf_comp_FieldIdEnum atf_comp::value_GetEnum(const atf_comp::FieldId& parent) throw() {
    return atf_comp_FieldIdEnum(parent.value);
}

// --- atf_comp.FieldId.value.SetEnum
// Set value of field from enum type.
inline void atf_comp::value_SetEnum(atf_comp::FieldId& parent, atf_comp_FieldIdEnum rhs) throw() {
    parent.value = i32(rhs);
}

// --- atf_comp.FieldId.value.Cast
inline  atf_comp::FieldId::operator atf_comp_FieldIdEnum() const throw() {
...
inline  atf_comp::FieldId::FieldId() throw() {
    atf_comp::FieldId_Init(*this);
}

// --- atf_comp.FieldId..FieldwiseCtor
inline  atf_comp::FieldId::FieldId(i32 in_value) throw()
    : value(in_value)
 {
}

// --- atf_comp.FieldId..EnumCtor
inline  atf_comp::FieldId::FieldId(atf_comp_FieldIdEnum arg) throw() {
    this->value = i32(arg);
}

// --- atf_comp.TableId.value.GetEnum
// Get value of field as enum type
inline atf_comp_TableIdEnum atf_comp::value_GetEnum(const atf_comp::TableId& parent) throw() {
    return atf_comp_TableIdEnum(parent.value);
}

// --- atf_comp.TableId.value.SetEnum
// Set value of field from enum type.
inline void atf_comp::value_SetEnum(atf_comp::TableId& parent, atf_comp_TableIdEnum rhs) throw() {
    parent.value = i32(rhs);
}

// --- atf_comp.TableId.value.Cast
inline  atf_comp::TableId::operator atf_comp_TableIdEnum() const throw() {
...
inline  atf_comp::TableId::TableId() throw() {
    atf_comp::TableId_Init(*this);
}

// --- atf_comp.TableId..FieldwiseCtor
inline  atf_comp::TableId::TableId(i32 in_value) throw()
    : value(in_value)
 {
}

// --- atf_comp.TableId..EnumCtor
inline  atf_comp::TableId::TableId(atf_comp_TableIdEnum arg) throw() {
    this->value = i32(arg);
}
