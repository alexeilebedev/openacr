...
enum algo_FieldIdEnum {                    // algo.FieldId.value
     algo_FieldId_name               = 0
    ,algo_FieldId_type               = 1
    ,algo_FieldId_value              = 2
    ,algo_FieldId_optional           = 3
    ,algo_FieldId_anon               = 4
    ,algo_FieldId_ch                 = 5
    ,algo_FieldId_min                = 6
    ,algo_FieldId_max                = 7
    ,algo_FieldId_append             = 8
    ,algo_FieldId_read               = 9
...
namespace algo { struct Argtuple; }
namespace algo { struct Arrsimp; }
...
bool                 ch_Eq(const algo::cstring& error,const algo::cstring &rhs) __attribute__((nothrow));
int                  ch_Cmp(algo::cstring& error, algo::cstring &rhs) __attribute__((nothrow));
// Reserve space (this may move memory). Insert N element at the end.
// Return aryptr to newly inserted block.
// If the RHS argument aliases the array (refers to the same memory), exit program with fatal error.
algo::aryptr<char>   ch_Addary(algo::cstring& error, algo::aryptr<char> rhs) __attribute__((nothrow));
// Reserve space. Insert element at the end
// The new element is initialized to a default value
char&                ch_Alloc(algo::cstring& error) __attribute__((__warn_unused_result__, nothrow));
// Reserve space for new element, reallocating the array if necessary
// Insert new element at specified index. Index must be in range or a fatal error occurs.
char&                ch_AllocAt(algo::cstring& error, int at) __attribute__((__warn_unused_result__, nothrow));
// Reserve space. Insert N elements at the end of the array, return pointer to array
algo::aryptr<char>   ch_AllocN(algo::cstring& error, int n_elems) __attribute__((__warn_unused_result__, nothrow));
// Return true if index is empty
bool                 ch_EmptyQ(algo::cstring& error) __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
char*                ch_Find(algo::cstring& error, u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return array pointer by value
algo::aryptr<char>   ch_Getary(algo::cstring& error) __attribute__((nothrow));
// Return pointer to last element of array, or NULL if array is empty
char*                ch_Last(algo::cstring& error) __attribute__((nothrow, pure));
// Return max. number of items in the array
i32                  ch_Max(algo::cstring& error) __attribute__((nothrow));
// Return number of items in the array
i32                  ch_N(const algo::cstring& error) __attribute__((__warn_unused_result__, nothrow, pure));
// Remove item by index. If index outside of range, do nothing.
void                 ch_Remove(algo::cstring& error, u32 i) __attribute__((nothrow));
void                 ch_RemoveAll(algo::cstring& error) __attribute__((nothrow));
// Delete last element of array. Do nothing if array is empty.
void                 ch_RemoveLast(algo::cstring& error) __attribute__((nothrow));
// Make sure N *more* elements will fit in array. Process dies if out of memory
void                 ch_Reserve(algo::cstring& error, int n) __attribute__((nothrow));
// Make sure N elements fit in array. Process dies if out of memory
void                 ch_AbsReserve(algo::cstring& error, int n) __attribute__((nothrow));
// Copy contents of RHS to PARENT.
void                 ch_Setary(algo::cstring& error, algo::cstring &rhs) __attribute__((nothrow));
// Copy specified array into ch, discarding previous contents.
// If the RHS argument aliases the array (refers to the same memory), throw exception.
void                 ch_Setary(algo::cstring& error, const algo::aryptr<char> &rhs) __attribute__((nothrow));
// 'quick' Access row by row id. No bounds checking.
char&                ch_qFind(algo::cstring& error, u64 t) __attribute__((nothrow));
...
void                 error_ch_curs_Reset(error_ch_curs &curs, algo::cstring &parent);
// cursor points to valid item
bool                 error_ch_curs_ValidQ(error_ch_curs &curs);
// item access
char&                error_ch_curs_Access(error_ch_curs &curs);
...
void                 cstring_Init(algo::cstring& error);
void                 cstring_Uninit(algo::cstring& error) __attribute__((nothrow));
...
// --- algo.ArgProto
// create: algo.Argtuple.proto (Tary)
struct ArgProto { // algo.ArgProto
    algo::cstring   name;       //
    algo::cstring   type;       //
    algo::cstring   value;      //
    bool            optional;   //   false
    bool            anon;       //   false  Anonymous arg?
    explicit ArgProto(const algo::strptr&            in_name
...
bool                 ArgProto_ReadFieldMaybe(algo::ArgProto &parent, algo::strptr field, algo::strptr strval) __attribute__((nothrow));
// Read fields of algo::ArgProto from an ascii string.
// The format of the string is an ssim Tuple
bool                 ArgProto_ReadStrptrMaybe(algo::ArgProto &parent, algo::strptr in_str);
// Set all fields to initial values.
void                 ArgProto_Init(algo::ArgProto& proto);
// print string representation of algo::ArgProto to string LHS, no header -- cprint:algo.ArgProto.String
void                 ArgProto_Print(algo::ArgProto & row, algo::cstring &str) __attribute__((nothrow));
...
struct Tuple { // algo.Tuple
    ...
    ~Tuple();
private:
    // reftype of algo.Tuple.attrs prohibits copy
...
// --- algo.Argtuple
struct Argtuple { // algo.Argtuple
    i32               anon_idx;      //   0  Index of next anonymous attr
    bool              vararg;        //   false  OK to accept unknown arguments
    bool              showsigs;      //   false  Show signature
    bool              endopt;        //   false  -- has been seen
    algo::Tuple       tuple;         //
    algo::ArgProto*   proto_elems;   // pointer to elements
    u32               proto_n;       // number of elements in array
    u32               proto_max;     // max. capacity of array before realloc
    algo::cstring     output;        // Output string
    algo::cstring*    error_elems;   // pointer to elements
    u32               error_n;       // number of elements in array
    u32               error_max;     // max. capacity of array before realloc
    bool              doexit;        //   false  Exit program?
    i32               exitcode;      //   0  Exit code for program
    bool              help;          //   false  Show help screen (out)
    bool              version;       //   false  Show version (out)
    bool              console;       //   false  Show console (windows only, out)
    Argtuple();
    ~Argtuple();
private:
    // value field algo.Argtuple.tuple is not copiable
    // reftype of algo.Argtuple.proto prohibits copy
    // reftype of algo.Argtuple.error prohibits copy
    // ... and several other reasons
    Argtuple(const Argtuple&){ /*disallow copy constructor */}
    void operator =(const Argtuple&){ /*disallow direct assignment */}
};

// Reserve space. Insert element at the end
// The new element is initialized to a default value
algo::ArgProto&      proto_Alloc(algo::Argtuple& parent) __attribute__((__warn_unused_result__, nothrow));
// Reserve space for new element, reallocating the array if necessary
// Insert new element at specified index. Index must be in range or a fatal error occurs.
algo::ArgProto&      proto_AllocAt(algo::Argtuple& parent, int at) __attribute__((__warn_unused_result__, nothrow));
// Reserve space. Insert N elements at the end of the array, return pointer to array
algo::aryptr<algo::ArgProto> proto_AllocN(algo::Argtuple& parent, int n_elems) __attribute__((__warn_unused_result__, nothrow));
// Return true if index is empty
bool                 proto_EmptyQ(algo::Argtuple& parent) __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
algo::ArgProto*      proto_Find(algo::Argtuple& parent, u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return array pointer by value
algo::aryptr<algo::ArgProto> proto_Getary(algo::Argtuple& parent) __attribute__((nothrow));
// Return pointer to last element of array, or NULL if array is empty
algo::ArgProto*      proto_Last(algo::Argtuple& parent) __attribute__((nothrow, pure));
// Return max. number of items in the array
i32                  proto_Max(algo::Argtuple& parent) __attribute__((nothrow));
// Return number of items in the array
i32                  proto_N(const algo::Argtuple& parent) __attribute__((__warn_unused_result__, nothrow, pure));
// Remove item by index. If index outside of range, do nothing.
void                 proto_Remove(algo::Argtuple& parent, u32 i) __attribute__((nothrow));
void                 proto_RemoveAll(algo::Argtuple& parent) __attribute__((nothrow));
// Delete last element of array. Do nothing if array is empty.
void                 proto_RemoveLast(algo::Argtuple& parent) __attribute__((nothrow));
// Make sure N *more* elements will fit in array. Process dies if out of memory
void                 proto_Reserve(algo::Argtuple& parent, int n) __attribute__((nothrow));
// Make sure N elements fit in array. Process dies if out of memory
void                 proto_AbsReserve(algo::Argtuple& parent, int n) __attribute__((nothrow));
// Copy contents of RHS to PARENT.
void                 proto_Setary(algo::Argtuple& parent, algo::Argtuple &rhs) __attribute__((nothrow));
// 'quick' Access row by row id. No bounds checking.
algo::ArgProto&      proto_qFind(algo::Argtuple& parent, u64 t) __attribute__((nothrow));
// Return reference to last element of array. No bounds checking
...
// Reserve space. Insert element at the end
// The new element is initialized to a default value
algo::cstring&       error_Alloc(algo::Argtuple& parent) __attribute__((__warn_unused_result__, nothrow));
// Reserve space for new element, reallocating the array if necessary
// Insert new element at specified index. Index must be in range or a fatal error occurs.
algo::cstring&       error_AllocAt(algo::Argtuple& parent, int at) __attribute__((__warn_unused_result__, nothrow));
// Reserve space. Insert N elements at the end of the array, return pointer to array
algo::aryptr<algo::cstring> error_AllocN(algo::Argtuple& parent, int n_elems) __attribute__((__warn_unused_result__, nothrow));
// Return true if index is empty
bool                 error_EmptyQ(algo::Argtuple& parent) __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
algo::cstring*       error_Find(algo::Argtuple& parent, u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return array pointer by value
algo::aryptr<algo::cstring> error_Getary(algo::Argtuple& parent) __attribute__((nothrow));
// Return pointer to last element of array, or NULL if array is empty
algo::cstring*       error_Last(algo::Argtuple& parent) __attribute__((nothrow, pure));
// Return max. number of items in the array
i32                  error_Max(algo::Argtuple& parent) __attribute__((nothrow));
// Return number of items in the array
i32                  error_N(const algo::Argtuple& parent) __attribute__((__warn_unused_result__, nothrow, pure));
// Remove item by index. If index outside of range, do nothing.
void                 error_Remove(algo::Argtuple& parent, u32 i) __attribute__((nothrow));
void                 error_RemoveAll(algo::Argtuple& parent) __attribute__((nothrow));
// Delete last element of array. Do nothing if array is empty.
void                 error_RemoveLast(algo::Argtuple& parent) __attribute__((nothrow));
// Make sure N *more* elements will fit in array. Process dies if out of memory
void                 error_Reserve(algo::Argtuple& parent, int n) __attribute__((nothrow));
// Make sure N elements fit in array. Process dies if out of memory
void                 error_AbsReserve(algo::Argtuple& parent, int n) __attribute__((nothrow));
// Copy contents of RHS to PARENT.
void                 error_Setary(algo::Argtuple& parent, algo::Argtuple &rhs) __attribute__((nothrow));
// 'quick' Access row by row id. No bounds checking.
algo::cstring&       error_qFind(algo::Argtuple& parent, u64 t) __attribute__((nothrow));
// Return reference to last element of array. No bounds checking
...
void                 Argtuple_proto_curs_Reset(Argtuple_proto_curs &curs, algo::Argtuple &parent);
// cursor points to valid item
bool                 Argtuple_proto_curs_ValidQ(Argtuple_proto_curs &curs);
// item access
algo::ArgProto&      Argtuple_proto_curs_Access(Argtuple_proto_curs &curs);
// proceed to next item
void                 Argtuple_error_curs_Next(Argtuple_error_curs &curs);
void                 Argtuple_error_curs_Reset(Argtuple_error_curs &curs, algo::Argtuple &parent);
// cursor points to valid item
bool                 Argtuple_error_curs_ValidQ(Argtuple_error_curs &curs);
// item access
algo::cstring&       Argtuple_error_curs_Access(Argtuple_error_curs &curs);
// Set all fields to initial values.
void                 Argtuple_Init(algo::Argtuple& parent);
void                 Argtuple_Uninit(algo::Argtuple& parent) __attribute__((nothrow));
// print string representation of algo::Argtuple to string LHS, no header -- cprint:algo.Argtuple.String
void                 Argtuple_Print(algo::Argtuple & row, algo::cstring &str) __attribute__((nothrow));

// --- algo.Arrsimp
struct Arrsimp { // algo.Arrsimp
    i32*               out_elems;     // pointer to elements
    u32                out_n;         // number of elements in array
    u32                out_max;       // max. capacity of array before realloc
    algo::i32_Range*   stack_elems;   // pointer to elements
    u32                stack_n;       // number of elements in array
    u32                stack_max;     // max. capacity of array before realloc
    double             tol;           //   0.0
    Arrsimp();
    ~Arrsimp();
private:
    // reftype of algo.Arrsimp.out prohibits copy
    // reftype of algo.Arrsimp.stack prohibits copy
    Arrsimp(const Arrsimp&){ /*disallow copy constructor */}
    void operator =(const Arrsimp&){ /*disallow direct assignment */}
};

// Reserve space. Insert element at the end
// The new element is initialized to a default value
i32&                 out_Alloc(algo::Arrsimp& parent) __attribute__((__warn_unused_result__, nothrow));
// Reserve space for new element, reallocating the array if necessary
// Insert new element at specified index. Index must be in range or a fatal error occurs.
i32&                 out_AllocAt(algo::Arrsimp& parent, int at) __attribute__((__warn_unused_result__, nothrow));
// Reserve space. Insert N elements at the end of the array, return pointer to array
algo::aryptr<i32>    out_AllocN(algo::Arrsimp& parent, int n_elems) __attribute__((__warn_unused_result__, nothrow));
// Return true if index is empty
bool                 out_EmptyQ(algo::Arrsimp& parent) __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
i32*                 out_Find(algo::Arrsimp& parent, u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return array pointer by value
algo::aryptr<i32>    out_Getary(algo::Arrsimp& parent) __attribute__((nothrow));
// Return pointer to last element of array, or NULL if array is empty
i32*                 out_Last(algo::Arrsimp& parent) __attribute__((nothrow, pure));
// Return max. number of items in the array
i32                  out_Max(algo::Arrsimp& parent) __attribute__((nothrow));
// Return number of items in the array
i32                  out_N(const algo::Arrsimp& parent) __attribute__((__warn_unused_result__, nothrow, pure));
// Remove item by index. If index outside of range, do nothing.
void                 out_Remove(algo::Arrsimp& parent, u32 i) __attribute__((nothrow));
void                 out_RemoveAll(algo::Arrsimp& parent) __attribute__((nothrow));
// Delete last element of array. Do nothing if array is empty.
void                 out_RemoveLast(algo::Arrsimp& parent) __attribute__((nothrow));
// Make sure N *more* elements will fit in array. Process dies if out of memory
void                 out_Reserve(algo::Arrsimp& parent, int n) __attribute__((nothrow));
// Make sure N elements fit in array. Process dies if out of memory
void                 out_AbsReserve(algo::Arrsimp& parent, int n) __attribute__((nothrow));
// Copy contents of RHS to PARENT.
void                 out_Setary(algo::Arrsimp& parent, algo::Arrsimp &rhs) __attribute__((nothrow));
// 'quick' Access row by row id. No bounds checking.
i32&                 out_qFind(algo::Arrsimp& parent, u64 t) __attribute__((nothrow));
// Return reference to last element of array. No bounds checking
...
// Reserve space. Insert element at the end
// The new element is initialized to a default value
algo::i32_Range&     stack_Alloc(algo::Arrsimp& parent) __attribute__((__warn_unused_result__, nothrow));
// Reserve space for new element, reallocating the array if necessary
// Insert new element at specified index. Index must be in range or a fatal error occurs.
algo::i32_Range&     stack_AllocAt(algo::Arrsimp& parent, int at) __attribute__((__warn_unused_result__, nothrow));
// Reserve space. Insert N elements at the end of the array, return pointer to array
algo::aryptr<algo::i32_Range> stack_AllocN(algo::Arrsimp& parent, int n_elems) __attribute__((__warn_unused_result__, nothrow));
// Return true if index is empty
bool                 stack_EmptyQ(algo::Arrsimp& parent) __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
algo::i32_Range*     stack_Find(algo::Arrsimp& parent, u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return array pointer by value
algo::aryptr<algo::i32_Range> stack_Getary(algo::Arrsimp& parent) __attribute__((nothrow));
// Return pointer to last element of array, or NULL if array is empty
algo::i32_Range*     stack_Last(algo::Arrsimp& parent) __attribute__((nothrow, pure));
// Return max. number of items in the array
i32                  stack_Max(algo::Arrsimp& parent) __attribute__((nothrow));
// Return number of items in the array
i32                  stack_N(const algo::Arrsimp& parent) __attribute__((__warn_unused_result__, nothrow, pure));
// Remove item by index. If index outside of range, do nothing.
void                 stack_Remove(algo::Arrsimp& parent, u32 i) __attribute__((nothrow));
void                 stack_RemoveAll(algo::Arrsimp& parent) __attribute__((nothrow));
// Delete last element of array. Do nothing if array is empty.
void                 stack_RemoveLast(algo::Arrsimp& parent) __attribute__((nothrow));
// Make sure N *more* elements will fit in array. Process dies if out of memory
void                 stack_Reserve(algo::Arrsimp& parent, int n) __attribute__((nothrow));
// Make sure N elements fit in array. Process dies if out of memory
void                 stack_AbsReserve(algo::Arrsimp& parent, int n) __attribute__((nothrow));
// Copy contents of RHS to PARENT.
void                 stack_Setary(algo::Arrsimp& parent, algo::Arrsimp &rhs) __attribute__((nothrow));
// 'quick' Access row by row id. No bounds checking.
algo::i32_Range&     stack_qFind(algo::Arrsimp& parent, u64 t) __attribute__((nothrow));
// Return reference to last element of array. No bounds checking
...
void                 Arrsimp_out_curs_Reset(Arrsimp_out_curs &curs, algo::Arrsimp &parent);
// cursor points to valid item
bool                 Arrsimp_out_curs_ValidQ(Arrsimp_out_curs &curs);
// item access
i32&                 Arrsimp_out_curs_Access(Arrsimp_out_curs &curs);
// proceed to next item
void                 Arrsimp_stack_curs_Next(Arrsimp_stack_curs &curs);
void                 Arrsimp_stack_curs_Reset(Arrsimp_stack_curs &curs, algo::Arrsimp &parent);
// cursor points to valid item
bool                 Arrsimp_stack_curs_ValidQ(Arrsimp_stack_curs &curs);
// item access
algo::i32_Range&     Arrsimp_stack_curs_Access(Arrsimp_stack_curs &curs);
// Set all fields to initial values.
void                 Arrsimp_Init(algo::Arrsimp& parent);
void                 Arrsimp_Uninit(algo::Arrsimp& parent) __attribute__((nothrow));
...
struct ByteAry { // algo.ByteAry
    ...
    ~ByteAry();
private:
    // reftype of algo.ByteAry.ary prohibits copy
...
struct LineBuf { // algo.LineBuf
    ...
    ~LineBuf();
private:
    // reftype of algo.LineBuf.buf prohibits copy
...
struct NormTxttbl { // algo.NormTxttbl
    ...
    ~NormTxttbl();
private:
    // reftype of algo.NormTxttbl.start prohibits copy
...
bool                 sha1sig_Eq(const algo::Sha1sig& parent, const algo::Sha1sig &rhs) __attribute__((nothrow));
...
struct U64Ary { // algo.U64Ary
    ...
    ~U64Ary();
private:
    // reftype of algo.U64Ary.ary prohibits copy
...
// Set all fields to initial values.
void                 i32_Range_Init(algo::i32_Range& stack);
...
struct error_ch_curs {// cursor
    ...
    int n_elems;
    int index;
    error_ch_curs() { elems=NULL; n_elems=0; index=0; }
};
...
struct Argtuple_proto_curs {// cursor
    typedef algo::ArgProto ChildType;
    algo::ArgProto* elems;
    int n_elems;
    int index;
    Argtuple_proto_curs() { elems=NULL; n_elems=0; index=0; }
};


struct Argtuple_error_curs {// cursor
    typedef algo::cstring ChildType;
    algo::cstring* elems;
    int n_elems;
    int index;
    Argtuple_error_curs() { elems=NULL; n_elems=0; index=0; }
};


struct Arrsimp_out_curs {// cursor
    typedef i32 ChildType;
    i32* elems;
    int n_elems;
    int index;
    Arrsimp_out_curs() { elems=NULL; n_elems=0; index=0; }
};


struct Arrsimp_stack_curs {// cursor
    typedef algo::i32_Range ChildType;
    algo::i32_Range* elems;
    int n_elems;
    int index;
    Arrsimp_stack_curs() { elems=NULL; n_elems=0; index=0; }
};
...
inline algo::cstring &operator <<(algo::cstring &str, const algo::Argtuple &row);// cfmt:algo.Argtuple.String
