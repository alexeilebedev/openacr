...
enum dev_FieldIdEnum {                    // dev.FieldId.value
    ...
    ,dev_FieldId_mr                = 61
    ,dev_FieldId_source_branch     = 62
    ,dev_FieldId_pipeline_status   = 63
    ,dev_FieldId_strict            = 64
    ,dev_FieldId_opt_type          = 65
    ,dev_FieldId_sep               = 66
    ,dev_FieldId_inl               = 67
    ,dev_FieldId_sandbox           = 68
    ,dev_FieldId_filter            = 69
    ,dev_FieldId_sbpath            = 70
    ,dev_FieldId_args              = 71
    ,dev_FieldId_ssimfs            = 72
    ,dev_FieldId_ssimfile          = 73
    ,dev_FieldId_file              = 74
