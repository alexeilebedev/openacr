...
bool                 srcfile_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FSrcfile*       srcfile_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
...
abt::FSrcfile&       srcfile_qFind(u64 t) __attribute__((nothrow));
...
// Look up row by row id. Return NULL if out of range
abt::FTargdep*       targdep_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FTargdep&       targdep_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 tool_opt_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FToolOpt*       tool_opt_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FToolOpt&       tool_opt_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FTarget*        target_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FTarget&        target_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FTargsrc*       targsrc_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FTargsrc&       targsrc_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FSyscmddep*     syscmddep_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FSyscmddep&     syscmddep_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FSyscmd*        syscmd_Find(i32 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FSyscmd&        syscmd_qFind(i32 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FCfg*           cfg_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FCfg&           cfg_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 uname_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FUname*         uname_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FUname&         uname_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 compiler_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FCompiler*      compiler_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FCompiler&      compiler_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 arch_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FArch*          arch_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FArch&          arch_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 zs_srcfile_read_EmptyQ() __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 zs_sel_target_EmptyQ() __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
...
// Return true if index is empty
bool                 targsyslib_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FTargsyslib*    targsyslib_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FTargsyslib&    targsyslib_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 syslib_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FSyslib*        syslib_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FSyslib&        syslib_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 include_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FInclude*       include_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FInclude&       include_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Look up row by row id. Return NULL if out of range
abt::FNs*            ns_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FNs&            ns_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 filestat_EmptyQ() __attribute__((nothrow));
// Look up row by row id. Return NULL if out of range
abt::FFilestat*      filestat_Find(u64 t) __attribute__((__warn_unused_result__, nothrow));
// Return pointer to last element of array, or NULL if array is empty
...
// 'quick' Access row by row id. No bounds checking.
abt::FFilestat&      filestat_qFind(u64 t) __attribute__((nothrow));
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
...
// Return true if index is empty
bool                 zd_include_EmptyQ(abt::FSrcfile& srcfile) __attribute__((__warn_unused_result__, nothrow));
// If index empty, return NULL. Otherwise return pointer to first element in index
