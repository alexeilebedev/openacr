...
template<class B, class C, class D> inline algo::THook<B,C,D>::THook() : ctx(NULL) , fcn(NULL) {
}

template<class B, class C, class D> inline algo::THook<B,C,D>::THook(void *in_ctx, HookFcn in_fcn) : ctx(in_ctx) , fcn(in_fcn) {
}

inline THook<> algo::Hook(void (*in_fcn)()) {
    typedef THook<>::HookFcn Fcn;
    return THook<>(NULL, Fcn(in_fcn));
}

template<class Ctx> inline THook<> algo::Hook(Ctx *in_ctx, void (*in_fcn)(Ctx*)) {
    typedef typename THook<>::HookFcn Fcn;
    return THook<>(in_ctx, Fcn(in_fcn));
}
...
template<class Ctx,class B> inline THook<B> algo::Hook(Ctx *in_ctx, void (*in_fcn)(Ctx*,B)) {
    typedef typename THook<B>::HookFcn Fcn;
    return THook<B>(in_ctx, Fcn(in_fcn));
}
...
template<class Ctx,class B,class C> inline THook<B,C> algo::Hook(Ctx *in_ctx, void (*in_fcn)(Ctx*,B,C)) {
    typedef typename THook<B,C>::HookFcn Fcn;
    return THook<B,C>(in_ctx, Fcn(in_fcn));
}
...
template<class Ctx,class B,class C, class D> inline THook<B,C,D> algo::Hook(Ctx *in_ctx, void (*in_fcn)(Ctx*,B,C,D)) {
    typedef typename THook<B,C,D>::HookFcn Fcn;
    return THook<B,C,D>(in_ctx, Fcn(in_fcn));
}
...
inline void algo::qCall(const THook<> &hook) {
    typedef void (*Func)(void*);
    Func(hook.fcn)(hook.ctx);
}

template<class B> inline void algo::qCall(const THook<B> &hook, B arg1) {
    typedef void (*Func)(void*,B);
    Func(hook.fcn)(hook.ctx, arg1);
}

template<class B, class C> inline void algo::qCall(const THook<B,C> &hook, B arg1, C arg2) {
    typedef void (*Func)(void*,B,C);
    Func(hook.fcn)(hook.ctx, arg1, arg2);
}

template<class B, class C, class D> inline void algo::qCall(const THook<B,C,D> &hook, B arg1, C arg2, D arg3) {
    typedef void (*Func)(void*,B,C,D);
    Func(hook.fcn)(hook.ctx, arg1, arg2, arg3);
}

inline void algo::NoOp() {
}
