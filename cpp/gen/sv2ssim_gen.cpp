...
// --- sv2ssim.FDb._db.MainArgs
// Main function
void sv2ssim::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,sv2ssim_syntax, sv2ssim_help);
    vrfy(sv2ssim_ReadTupleMaybe(sv2ssim::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(sv2ssim::LoadTuplesMaybe(sv2ssim::_db.cmdline.in)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    sv2ssim::Main(); // call through to user-defined main
}
...
bool sv2ssim::FieldId_ReadStrptrMaybe(sv2ssim::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && sv2ssim::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
...
int main(int argc, char **argv) {
    try {
        ...
        algo_lib::IohookInit();
        sv2ssim::MainArgs(algo_lib::_db.argc,algo_lib::_db.argv); // dmmeta.main:sv2ssim
