...
// --- atf_comp.FDb._db.MainArgs
// Main function
void atf_comp::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,atf_comp_syntax, atf_comp_help);
    vrfy(atf_comp_ReadTupleMaybe(atf_comp::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(atf_comp::LoadTuplesMaybe(atf_comp::_db.cmdline.in)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    atf_comp::Main(); // call through to user-defined main
}
...
bool atf_comp::FieldId_ReadStrptrMaybe(atf_comp::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && atf_comp::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
...
int main(int argc, char **argv) {
    try {
        ...
        algo_lib::IohookInit();
        atf_comp::MainArgs(algo_lib::_db.argc,algo_lib::_db.argv); // dmmeta.main:atf_comp
