...
const char *atf_cov_syntax =
"-in:string=\"data\"\n"
" -covdir:string=\"temp/covdata\"\n"
" -logfile:string=\n"
" -runcmd:string=\n"
" -exclude:string=\"(extern|include/gen|cpp/gen)/%\"\n"
" -mergepath:string=\n"
" -gcov:flag\n"
" -ssim:flag\n"
" -report:flag\n"
...
// --- atf_cov.FDb._db.MainArgs
// Main function
void atf_cov::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,atf_cov_syntax, atf_cov_help);
    vrfy(atf_cov_ReadTupleMaybe(atf_cov::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(atf_cov::LoadTuplesMaybe(atf_cov::_db.cmdline.in)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    atf_cov::Main(); // call through to user-defined main
}
...
static void atf_cov::InitReflection() {
    ...
    algo_lib::InsertStrptrMaybe("dmmeta.Dispsigcheck  dispsig:'atf_cov.Input'  signature:'4d7b61ad4c12fc6d46fa80acbdd04db49e2fb480'");
}
...
bool atf_cov::LoadTuplesMaybe(algo::strptr root) {
    bool retval = true;
    static const char *ssimfiles[] = {
        "dev.gitfile", "dev.covfile", "dev.covline", "dev.target"
        , "dev.covtarget", "dev.targsrc", "dev.tgtcov"
        , NULL};
        retval = algo_lib::DoLoadTuples(root, atf_cov::InsertStrptrMaybe, ssimfiles, true);
        return retval;
}

// --- atf_cov.FDb._db.LoadSsimfileMaybe
// Load specified ssimfile.
bool atf_cov::LoadSsimfileMaybe(algo::strptr fname) {
    bool retval = true;
    if (FileQ(fname)) {
        retval = algo_lib::LoadTuplesFile(fname, atf_cov::InsertStrptrMaybe, true);
    }
    return retval;
}
...
bool atf_cov::FieldId_ReadStrptrMaybe(atf_cov::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && atf_cov::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
...
int main(int argc, char **argv) {
    try {
        ...
        algo_lib::IohookInit();
        atf_cov::MainArgs(algo_lib::_db.argc,algo_lib::_db.argv); // dmmeta.main:atf_cov
