...
"Usage: amc_vis [options]\n"
"    [ctype]   string  Ctype regexp to compute access path diagram. default: \"%\"\n"
"    -in       string  Input directory or filename, - for stdin. default: \"data\"\n"
"    -dot      string  Save dot file with specified filename\n"
"    -xref             Include all ctypes referenced by selected ones. default: false\n"
"    -xns              Cross namespace boundaries. default: false\n"
"    -noinput          Deselect module inputs. default: false\n"
"    -check            Check model for dependency problems. default: false\n"
"    -render           Produce an ascii drawing. default: true\n"
...
// --- amc_vis.FDb._db.MainArgs
// Main function
void amc_vis::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,amc_vis_syntax, amc_vis_help);
    vrfy(amc_vis_ReadTupleMaybe(amc_vis::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(amc_vis::LoadTuplesMaybe(amc_vis::_db.cmdline.in)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    amc_vis::Main(); // call through to user-defined main
}
...
bool amc_vis::FieldId_ReadStrptrMaybe(amc_vis::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && amc_vis::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
...
int main(int argc, char **argv) {
    try {
        ...
        amc_vis::MainArgs(algo_lib::_db.argc,algo_lib::_db.argv); // dmmeta.main:amc_vis
