...
namespace abt_md { // gen:ns_print_proto
    ...
    // func:abt_md.FDb.readmefile.InputMaybe
...
void abt_md::FCheckKey_Uninit(abt_md::FCheckKey& parent) {
    ind_checkkey_Remove(parent); // remove checkkey from index ind_checkkey
}

// --- abt_md.FCheckReq..Uninit
void abt_md::FCheckReq_Uninit(abt_md::FCheckReq& parent) {
    ind_checkreq_Remove(parent); // remove checkreq from index ind_checkreq
}
...
algo::strptr abt_md::target_Get(abt_md::FComptest& parent) {
    return algo::Pathcomp(parent.comptest, ".LL");
}

// --- abt_md.FComptest.testname.Get
algo::strptr abt_md::testname_Get(abt_md::FComptest& parent) {
    return algo::Pathcomp(parent.comptest, ".LR");
}

// --- abt_md.FComptest..Uninit
void abt_md::FComptest_Uninit(abt_md::FComptest& parent) {
    abt_md::FNs* p_target = abt_md::ind_ns_Find(target_Get(parent));
    if (p_target)  {
        c_comptest_Remove(*p_target, parent);// remove comptest from index c_comptest
    }
}
...
algo::strptr abt_md::ns_Get(abt_md::FCtype& parent) {
    return algo::Pathcomp(parent.ctype, ".RL");
}

// --- abt_md.FCtype.name.Get
algo::strptr abt_md::name_Get(abt_md::FCtype& parent) {
...
void abt_md::c_field_Insert(abt_md::FCtype& parent, abt_md::FField& row) {
...
bool abt_md::c_field_InsertMaybe(abt_md::FCtype& parent, abt_md::FField& row) {
...
void abt_md::c_field_Remove(abt_md::FCtype& parent, abt_md::FField& row) {
    i64 n = parent.c_field_n;
    if (bool_Update(row.ctype_c_field_in_ary,false)) {
        abt_md::FField* *elems = parent.c_field_elems;
        ...
        for (i64 i = n-1; i>=0; i--) {
            ...
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FField*) * (n - j);
...
void abt_md::c_field_Reserve(abt_md::FCtype& parent, u64 n) {
    ...
    if (UNLIKELY(parent.c_field_n + n > old_max)) {
        ...
        u64 old_size = old_max * sizeof(abt_md::FField*);
        u64 new_size = new_max * sizeof(abt_md::FField*);
        ...
        parent.c_field_elems = (abt_md::FField**)new_mem;
...
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_field_arg_Insert(abt_md::FCtype& parent, abt_md::FField& row) {
    if (!row.ctype_c_field_arg_in_ary) {
        c_field_arg_Reserve(parent, 1);
        u64 n  = parent.c_field_arg_n++;
        parent.c_field_arg_elems[n] = &row;
...
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_field_arg_InsertMaybe(abt_md::FCtype& parent, abt_md::FField& row) {
    bool retval = !ctype_c_field_arg_InAryQ(row);
    c_field_arg_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FCtype.c_field_arg.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_field_arg_Remove(abt_md::FCtype& parent, abt_md::FField& row) {
    i64 n = parent.c_field_arg_n;
    if (bool_Update(row.ctype_c_field_arg_in_ary,false)) {
        abt_md::FField* *elems = parent.c_field_arg_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            abt_md::FField* elem = elems[i]; // fetch element
...
// Reserve space in index for N more elements;
void abt_md::c_field_arg_Reserve(abt_md::FCtype& parent, u64 n) {
    u64 old_max = parent.c_field_arg_max;
    if (UNLIKELY(parent.c_field_arg_n + n > old_max)) {
        u64 new_max  = u64_Max(u64_Max(old_max * 2, parent.c_field_arg_n + n), 4);
        u64 old_size = old_max * sizeof(abt_md::FField*);
        u64 new_size = new_max * sizeof(abt_md::FField*);
        void *new_mem = algo_lib::malloc_ReallocMem(parent.c_field_arg_elems, old_size, new_size);
        if (UNLIKELY(!new_mem)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FCtype.c_field_arg");
        }
        parent.c_field_arg_elems = (abt_md::FField**)new_mem;
        parent.c_field_arg_max = new_max;
    }
}

// --- abt_md.FCtype..Uninit
void abt_md::FCtype_Uninit(abt_md::FCtype& parent) {
    ind_ctype_Remove(parent); // remove ctype from index ind_ctype
    abt_md::FNs* p_ns = abt_md::ind_ns_Find(ns_Get(parent));
    if (p_ns)  {
        c_ctype_Remove(*p_ns, parent);// remove ctype from index c_ctype
    }

    // abt_md.FCtype.c_field_arg.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_field_arg_elems, sizeof(abt_md::FField*)*parent.c_field_arg_max); // (abt_md.FCtype.c_field_arg)

    // abt_md.FCtype.c_field.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_field_elems, sizeof(abt_md::FField*)*parent.c_field_max); // (abt_md.FCtype.c_field)
}
...
void abt_md::regx_match_Print(abt_md::FMdsection& parent, algo::cstring &out) {
    Regx_Print(parent.regx_match, out);
}

// --- abt_md.FMdsection.regx_path.Print
// Print back to string
void abt_md::regx_path_Print(abt_md::FMdsection& parent, algo::cstring &out) {
    Regx_Print(parent.regx_path, out);
}

// --- abt_md.FMdsection.zd_file_section.Insert
// Insert row into linked list. If row is already in linked list, do nothing.
void abt_md::zd_file_section_Insert(abt_md::FMdsection& parent, abt_md::FFileSection& row) {
    if (!mdsection_zd_file_section_InLlistQ(row)) {
        abt_md::FFileSection* old_tail = parent.zd_file_section_tail;
        row.mdsection_zd_file_section_next = NULL;
        row.mdsection_zd_file_section_prev = old_tail;
        parent.zd_file_section_tail = &row;
        abt_md::FFileSection **new_row_a = &old_tail->mdsection_zd_file_section_next;
        abt_md::FFileSection **new_row_b = &parent.zd_file_section_head;
        abt_md::FFileSection **new_row = old_tail ? new_row_a : new_row_b;
        *new_row = &row;
        parent.zd_file_section_n++;
    }
}

// --- abt_md.FMdsection.zd_file_section.Remove
// Remove element from index. If element is not in index, do nothing.
void abt_md::zd_file_section_Remove(abt_md::FMdsection& parent, abt_md::FFileSection& row) {
    if (mdsection_zd_file_section_InLlistQ(row)) {
        abt_md::FFileSection* old_head       = parent.zd_file_section_head;
        (void)old_head; // in case it's not used
        abt_md::FFileSection* prev = row.mdsection_zd_file_section_prev;
        abt_md::FFileSection* next = row.mdsection_zd_file_section_next;
        // if element is first, adjust list head; otherwise, adjust previous element's next
        abt_md::FFileSection **new_next_a = &prev->mdsection_zd_file_section_next;
        abt_md::FFileSection **new_next_b = &parent.zd_file_section_head;
        ...
        *new_next = next;
        ...
        abt_md::FFileSection **new_prev_a = &next->mdsection_zd_file_section_prev;
        abt_md::FFileSection **new_prev_b = &parent.zd_file_section_tail;
        abt_md::FFileSection **new_prev = next ? new_prev_a : new_prev_b;
        *new_prev = prev;
        parent.zd_file_section_n--;
        row.mdsection_zd_file_section_next=(abt_md::FFileSection*)-1; // not-in-list
    }
}

// --- abt_md.FMdsection.zd_file_section.RemoveAll
// Empty the index. (The rows are not deleted)
void abt_md::zd_file_section_RemoveAll(abt_md::FMdsection& parent) {
    abt_md::FFileSection* row = parent.zd_file_section_head;
    parent.zd_file_section_head = NULL;
    parent.zd_file_section_tail = NULL;
    parent.zd_file_section_n = 0;
    while (row) {
        abt_md::FFileSection* row_next = row->mdsection_zd_file_section_next;
        row->mdsection_zd_file_section_next  = (abt_md::FFileSection*)-1;
        row->mdsection_zd_file_section_prev  = NULL;
        row = row_next;
    }
}
...
abt_md::FFileSection* abt_md::zd_file_section_RemoveFirst(abt_md::FMdsection& parent) {
    abt_md::FFileSection *row = NULL;
    row = parent.zd_file_section_head;
    if (row) {
        abt_md::FFileSection *next = row->mdsection_zd_file_section_next;
        parent.zd_file_section_head = next;
        abt_md::FFileSection **new_end_a = &next->mdsection_zd_file_section_prev;
        abt_md::FFileSection **new_end_b = &parent.zd_file_section_tail;
        abt_md::FFileSection **new_end = next ? new_end_a : new_end_b;
        *new_end = NULL;
        parent.zd_file_section_n--;
        row->mdsection_zd_file_section_next = (abt_md::FFileSection*)-1; // mark as not-in-list
    }
    return row;
}

// --- abt_md.FMdsection.zd_file_section.InsertBefore
// Insert row before given element, or at tail when before is NULL; no-op if row is already in list.
void abt_md::zd_file_section_InsertBefore(abt_md::FMdsection& parent, abt_md::FFileSection& row, abt_md::FFileSection* before) {
    if (!mdsection_zd_file_section_InLlistQ(row) && &row != before) {
        abt_md::FFileSection* next = before;
        abt_md::FFileSection* prev = next ? next->mdsection_zd_file_section_prev : parent.zd_file_section_tail;
        row.mdsection_zd_file_section_next = next;
        row.mdsection_zd_file_section_prev = prev;
        abt_md::FFileSection **prev_link_a = &prev->mdsection_zd_file_section_next;
        abt_md::FFileSection **prev_link_b = &parent.zd_file_section_head;
        *(prev ? prev_link_a : prev_link_b) = &row;
        abt_md::FFileSection **next_link_a = &next->mdsection_zd_file_section_prev;
        abt_md::FFileSection **next_link_b = &parent.zd_file_section_tail;
...
void abt_md::FMdsection_Init(abt_md::FMdsection& parent) {
    parent.rowid = i32(0);
    parent.zd_file_section_head = NULL; // (abt_md.FMdsection.zd_file_section)
    parent.zd_file_section_n = 0; // (abt_md.FMdsection.zd_file_section)
    parent.zd_file_section_tail = NULL; // (abt_md.FMdsection.zd_file_section)
    parent.step = NULL;
}
...
// Read argc,argv into the fields of abt_md.FDb.cmdline (and any base command line)
// via abt_md_ReadArgv; then apply -help/-version and load floadtuples input.
void abt_md::ReadArgv() {
    ...
    command::abt_md_ReadArgv(cmd, args, err);
    bool dohelp = false;
    bool doexit=false;
    ...
    // dmmeta.floadtuples:command.abt_md.in
    if (!dohelp && err=="") {
...
static void abt_md::InitReflection() {
    ...
    row.imdb               = "abt_md";
    row.InsertStrptrMaybe  = abt_md::InsertStrptrMaybe;
    row.RemoveStrptrMaybe  = abt_md::RemoveStrptrMaybe;
    row.Step               = NULL;
    row.MainLoop           = abt_md::MainLoop;
...
bool abt_md::InsertStrptrMaybe(algo::strptr str) {
    ...
    switch (value_GetEnum(table_id)) {
        case abt_md_TableId_dev_Readmefile: { // finput:abt_md.FDb.readmefile
            dev::Readmefile elem;
...
bool abt_md::LoadTuplesMaybe(algo::strptr root, bool recursive) {
    ...
    if (FileQ(root)) {
        ...
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.gstatic"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.gconst"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.finput"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.fconst"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.dispatch"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.dispsigcheck"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dmmeta.dispatch_msg"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dev.target"),recursive);
        retval = retval && abt_md::LoadTuplesFile(algo::SsimFname(root,"dev.gitfile"),recursive);
...
// --- abt_md.FDb._db.RemoveStrptrMaybe
// Parse strptr into known type and remove matching record from database.
// Return value is true if the record was found and removed, false otherwise.
bool abt_md::RemoveStrptrMaybe(algo::strptr str) {
    bool retval = true;
    abt_md::TableId table_id(-1);
    value_SetStrptrMaybe(table_id, algo::GetTypeTag(str));
    switch (value_GetEnum(table_id)) {
        case abt_md_TableId_dev_Readmefile: { // finput:abt_md.FDb.readmefile
            // finput abt_md.FDb.readmefile: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Ns: { // finput:abt_md.FDb.ns
            // finput abt_md.FDb.ns: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Ssimfile: { // finput:abt_md.FDb.ssimfile
            // finput abt_md.FDb.ssimfile: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Ctype: { // finput:abt_md.FDb.ctype
            // finput abt_md.FDb.ctype: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Field: { // finput:abt_md.FDb.field
            // finput abt_md.FDb.field: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dev_Targsrc: { // finput:abt_md.FDb.targsrc
            // finput abt_md.FDb.targsrc: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Substr: { // finput:abt_md.FDb.substr
            // finput abt_md.FDb.substr: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dev_Scriptfile: { // finput:abt_md.FDb.scriptfile
            // finput abt_md.FDb.scriptfile: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Nstype: { // finput:abt_md.FDb.nstype
            // finput abt_md.FDb.nstype: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_atfdb_Comptest: { // finput:abt_md.FDb.comptest
            // finput abt_md.FDb.comptest: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Reftype: { // finput:abt_md.FDb.reftype
            // finput abt_md.FDb.reftype: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_amcdb_Tclass: { // finput:abt_md.FDb.tclass
            // finput abt_md.FDb.tclass: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Fconst: { // finput:abt_md.FDb.fconst
            // finput abt_md.FDb.fconst: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        ...
        case abt_md_TableId_dmmeta_Gstatic: { // finput:abt_md.FDb.gstatic
            // finput abt_md.FDb.gstatic: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dev_Target: { // finput:abt_md.FDb.target
            // finput abt_md.FDb.target: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dev_Targdep: { // finput:abt_md.FDb.targdep
            // finput abt_md.FDb.targdep: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Finput: { // finput:abt_md.FDb.finput
            // finput abt_md.FDb.finput: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_Dispatch: { // finput:abt_md.FDb.dispatch
            // finput abt_md.FDb.dispatch: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dmmeta_DispatchMsg: { // finput:abt_md.FDb.dispatch_msg
            // finput abt_md.FDb.dispatch_msg: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
        case abt_md_TableId_dev_Gitfile: { // finput:abt_md.FDb.gitfile
            // finput abt_md.FDb.gitfile: random delete unsupported
            // (need reftype del:Y plus a Thash on the pkey)
            retval = false;
            break;
        }
...
// --- abt_md.FDb.readmefile.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FReadmefile& abt_md::readmefile_Alloc() {
    abt_md::FReadmefile* row = readmefile_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.readmefile  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.readmefile.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FReadmefile* abt_md::readmefile_AllocMaybe() {
    abt_md::FReadmefile *row = (abt_md::FReadmefile*)readmefile_AllocMem();
    if (row) {
        new (row) abt_md::FReadmefile; // call constructor
    }
    return row;
}

// --- abt_md.FDb.readmefile.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FReadmefile* abt_md::readmefile_InsertMaybe(const dev::Readmefile &value) {
    abt_md::FReadmefile *row = &readmefile_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.readmefile.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::readmefile_AllocMem() {
    ...
    abt_md::FReadmefile*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.readmefile_lary[bsr];
        if (!lev) {
            lev=(abt_md::FReadmefile*)algo_lib::malloc_AllocMem(sizeof(abt_md::FReadmefile) * (u64(1)<<bsr));
...
// --- abt_md.FDb.readmefile.RemoveAll
// Remove all elements from Lary
void abt_md::readmefile_RemoveAll() {
...
// --- abt_md.FDb.readmefile.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::readmefile_RemoveLast() {
...
// --- abt_md.FDb.readmefile.InputMaybe
static bool abt_md::readmefile_InputMaybe(dev::Readmefile &elem) {
    bool retval = true;
    retval = readmefile_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.readmefile.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::readmefile_XrefMaybe(abt_md::FReadmefile &row) {
    bool retval = true;
    (void)row;
    ...
    if (true) { // user-defined insert condition
        ...
        if (UNLIKELY(!success)) {
            ...
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_readmefile"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// --- abt_md.FDb.ind_readmefile.Find
// Find row by key. Return NULL if not found.
abt_md::FReadmefile* abt_md::ind_readmefile_Find(const algo::strptr& key) {
    u32 index = algo::Smallstr200_Hash(0, key) & (_db.ind_readmefile_buckets_n - 1);
    abt_md::FReadmefile *ret = _db.ind_readmefile_buckets_elems[index];
    for (; ret && !((*ret).gitfile == key); ret = ret->ind_readmefile_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_readmefile.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FReadmefile& abt_md::ind_readmefile_FindX(const algo::strptr& key) {
    abt_md::FReadmefile* ret = ind_readmefile_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_readmefile  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_readmefile.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FReadmefile& abt_md::ind_readmefile_GetOrCreate(const algo::strptr& key) {
    abt_md::FReadmefile* ret = ind_readmefile_Find(key);
    ...
    vrfy(ret, tempstr() << "abt_md.create_error  table:ind_readmefile  key:'"<<key<<"'  comment:'bad xref'");
    return *ret;
}

// --- abt_md.FDb.ind_readmefile.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_readmefile_InsertMaybe(abt_md::FReadmefile& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_readmefile_next == (abt_md::FReadmefile*)-1)) {// check if in hash already
        ...
        abt_md::FReadmefile* *prev = &_db.ind_readmefile_buckets_elems[index];
        do {
            abt_md::FReadmefile* ret = *prev;
...
// --- abt_md.FDb.ind_readmefile.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_readmefile_Remove(abt_md::FReadmefile& row) {
    if (LIKELY(row.ind_readmefile_next != (abt_md::FReadmefile*)-1)) {// check if in hash already
        u32 index = row.ind_readmefile_hashval & (_db.ind_readmefile_buckets_n - 1);
        abt_md::FReadmefile* *prev = &_db.ind_readmefile_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FReadmefile *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_readmefile_next; // unlink (singly linked list)
                _db.ind_readmefile_n--;
                row.ind_readmefile_next = (abt_md::FReadmefile*)-1;// not-in-hash
                break;
            }
...
// --- abt_md.FDb.ind_readmefile.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_readmefile_Reserve(int n) {
    ind_readmefile_AbsReserve(_db.ind_readmefile_n + n);
}

// --- abt_md.FDb.ind_readmefile.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_readmefile_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_readmefile_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FReadmefile*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FReadmefile*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FReadmefile* *new_buckets = (abt_md::FReadmefile**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_readmefile");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_readmefile_buckets_n; i++) {
            abt_md::FReadmefile* elem = _db.ind_readmefile_buckets_elems[i];
            while (elem) {
                abt_md::FReadmefile &row        = *elem;
                abt_md::FReadmefile* next       = row.ind_readmefile_next;
...
void* abt_md::file_section_AllocMem() {
    ...
    // allocate element from this level
    if (lev) {
        _db.file_section_n = i64(new_nelems);
        ret = lev + index;
    }
    return ret;
}
...
abt_md::FNs* abt_md::ind_ns_Find(const algo::strptr& key) {
    ...
    abt_md::FNs *ret = _db.ind_ns_buckets_elems[index];
...
// --- abt_md.FDb.ind_ns.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_ns_AbsReserve(int n) {
...
abt_md::FSsimfile* abt_md::ind_ssimfile_Find(const algo::strptr& key) {
    ...
    abt_md::FSsimfile *ret = _db.ind_ssimfile_buckets_elems[index];
...
// --- abt_md.FDb.ind_ssimfile.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FSsimfile* abt_md::ind_ssimfile_GetOrCreate(const algo::strptr& key) {
    abt_md::FSsimfile* ret = ind_ssimfile_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &ssimfile_Alloc();
        (*ret).ssimfile = key;
...
// --- abt_md.FDb.ind_ssimfile.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_ssimfile_AbsReserve(int n) {
...
abt_md::FCtype* abt_md::ind_ctype_Find(const algo::strptr& key) {
    ...
    abt_md::FCtype *ret = _db.ind_ctype_buckets_elems[index];
...
// --- abt_md.FDb.ind_ctype.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_ctype_AbsReserve(int n) {
...
abt_md::FField* abt_md::ind_field_Find(const algo::strptr& key) {
    ...
    abt_md::FField *ret = _db.ind_field_buckets_elems[index];
...
// --- abt_md.FDb.ind_field.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FField* abt_md::ind_field_GetOrCreate(const algo::strptr& key) {
    abt_md::FField* ret = ind_field_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &field_Alloc();
        (*ret).field = key;
...
// --- abt_md.FDb.ind_field.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_field_AbsReserve(int n) {
...
void* abt_md::human_text_AllocMem() {
    ...
    algo_lib::MemcheckAlloc(row, sizeof(abt_md::FHumanText));
    return row;
}
...
void abt_md::human_text_FreeMem(abt_md::FHumanText &row) {
    ...
    algo_lib::MemcheckFree(&row, sizeof(abt_md::FHumanText)); // before the free list threads through the element
...
abt_md::FHumanText* abt_md::ind_human_text_Find(const algo::strptr& key) {
    ...
    abt_md::FHumanText *ret = _db.ind_human_text_buckets_elems[index];
    for (; ret && !((*ret).key == key); ret = ret->ind_human_text_next) {
    }
    return ret;
}
...
bool abt_md::ind_human_text_InsertMaybe(abt_md::FHumanText& row) {
    ...
    if (LIKELY(row.ind_human_text_next == (abt_md::FHumanText*)-1)) {// check if in hash already
        row.ind_human_text_hashval = algo::cstring_Hash(0, row.key);
        ind_human_text_Reserve(1);
        u32 index = row.ind_human_text_hashval & (_db.ind_human_text_buckets_n - 1);
...
void abt_md::ind_human_text_Reserve(int n) {
    ind_human_text_AbsReserve(_db.ind_human_text_n + n);
}

// --- abt_md.FDb.ind_human_text.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_human_text_AbsReserve(int n) {
    ...
    if (new_nelems > old_nbuckets) {
        ...
        for (int i = 0; i < _db.ind_human_text_buckets_n; i++) {
            ...
            while (elem) {
                ...
                u32 index          = row.ind_human_text_hashval & (new_nbuckets-1);
...
abt_md::FScriptfile* abt_md::ind_scriptfile_Find(const algo::strptr& key) {
    ...
    abt_md::FScriptfile *ret = _db.ind_scriptfile_buckets_elems[index];
...
// --- abt_md.FDb.ind_scriptfile.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_scriptfile_AbsReserve(int n) {
...
abt_md::FNstype* abt_md::ind_nstype_Find(const algo::strptr& key) {
    ...
    abt_md::FNstype *ret = _db.ind_nstype_buckets_elems[index];
    for (; ret && !((*ret).nstype == key); ret = ret->ind_nstype_next) {
    }
    return ret;
}
...
bool abt_md::ind_nstype_InsertMaybe(abt_md::FNstype& row) {
    ...
    if (LIKELY(row.ind_nstype_next == (abt_md::FNstype*)-1)) {// check if in hash already
        row.ind_nstype_hashval = algo::Smallstr50_Hash(0, row.nstype);
        ind_nstype_Reserve(1);
        u32 index = row.ind_nstype_hashval & (_db.ind_nstype_buckets_n - 1);
...
void abt_md::ind_nstype_Reserve(int n) {
    ind_nstype_AbsReserve(_db.ind_nstype_n + n);
}

// --- abt_md.FDb.ind_nstype.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_nstype_AbsReserve(int n) {
    ...
    if (new_nelems > old_nbuckets) {
        ...
        for (int i = 0; i < _db.ind_nstype_buckets_n; i++) {
            ...
            while (elem) {
                ...
                u32 index          = row.ind_nstype_hashval & (new_nbuckets-1);
...
abt_md::FAnchor* abt_md::ind_anchor_Find(const algo::strptr& key) {
    ...
    abt_md::FAnchor *ret = _db.ind_anchor_buckets_elems[index];
    for (; ret && !((*ret).anchor == key); ret = ret->ind_anchor_next) {
    }
    return ret;
}
...
bool abt_md::ind_anchor_InsertMaybe(abt_md::FAnchor& row) {
    ...
    if (LIKELY(row.ind_anchor_next == (abt_md::FAnchor*)-1)) {// check if in hash already
        row.ind_anchor_hashval = algo::cstring_Hash(0, row.anchor);
        ind_anchor_Reserve(1);
        u32 index = row.ind_anchor_hashval & (_db.ind_anchor_buckets_n - 1);
...
void abt_md::ind_anchor_Reserve(int n) {
    ind_anchor_AbsReserve(_db.ind_anchor_n + n);
}

// --- abt_md.FDb.ind_anchor.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_anchor_AbsReserve(int n) {
    ...
    if (new_nelems > old_nbuckets) {
        ...
        for (int i = 0; i < _db.ind_anchor_buckets_n; i++) {
            ...
            while (elem) {
                ...
                u32 index          = row.ind_anchor_hashval & (new_nbuckets-1);
...
abt_md::FTclass* abt_md::ind_tclass_Find(const algo::strptr& key) {
    ...
    abt_md::FTclass *ret = _db.ind_tclass_buckets_elems[index];
    for (; ret && !((*ret).tclass == key); ret = ret->ind_tclass_next) {
    }
    return ret;
}
...
bool abt_md::ind_tclass_InsertMaybe(abt_md::FTclass& row) {
    ...
    if (LIKELY(row.ind_tclass_next == (abt_md::FTclass*)-1)) {// check if in hash already
        row.ind_tclass_hashval = algo::Smallstr50_Hash(0, row.tclass);
        ind_tclass_Reserve(1);
        u32 index = row.ind_tclass_hashval & (_db.ind_tclass_buckets_n - 1);
...
void abt_md::ind_tclass_Reserve(int n) {
    ind_tclass_AbsReserve(_db.ind_tclass_n + n);
}

// --- abt_md.FDb.ind_tclass.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_tclass_AbsReserve(int n) {
    ...
    if (new_nelems > old_nbuckets) {
        ...
        for (int i = 0; i < _db.ind_tclass_buckets_n; i++) {
            ...
            while (elem) {
                ...
                u32 index          = row.ind_tclass_hashval & (new_nbuckets-1);
...
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FGstatic& abt_md::gstatic_Alloc() {
    abt_md::FGstatic* row = gstatic_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.gstatic  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.gstatic.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FGstatic* abt_md::gstatic_AllocMaybe() {
    abt_md::FGstatic *row = (abt_md::FGstatic*)gstatic_AllocMem();
    if (row) {
        new (row) abt_md::FGstatic; // call constructor
    }
    return row;
}

// --- abt_md.FDb.gstatic.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FGstatic* abt_md::gstatic_InsertMaybe(const dmmeta::Gstatic &value) {
    abt_md::FGstatic *row = &gstatic_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.gstatic.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::gstatic_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FGstatic*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.gstatic_lary[bsr];
        if (!lev) {
            lev=(abt_md::FGstatic*)algo_lib::malloc_AllocMem(sizeof(abt_md::FGstatic) * (u64(1)<<bsr));
...
// --- abt_md.FDb.gstatic.RemoveAll
// Remove all elements from Lary
void abt_md::gstatic_RemoveAll() {
...
// --- abt_md.FDb.gstatic.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::gstatic_RemoveLast() {
    u64 n = _db.gstatic_n;
    if (n > 0) {
        n -= 1;
...
// --- abt_md.FDb.gstatic.InputMaybe
static bool abt_md::gstatic_InputMaybe(dmmeta::Gstatic &elem) {
    bool retval = true;
    retval = gstatic_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.gstatic.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::gstatic_XrefMaybe(abt_md::FGstatic &row) {
    bool retval = true;
    (void)row;
    // insert gstatic into index ind_gstatic
    if (true) { // user-defined insert condition
        bool success = ind_gstatic_InsertMaybe(row);
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_gstatic"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// --- abt_md.FDb.ind_gstatic.Find
// Find row by key. Return NULL if not found.
abt_md::FGstatic* abt_md::ind_gstatic_Find(const algo::strptr& key) {
    u32 index = algo::Smallstr150_Hash(0, key) & (_db.ind_gstatic_buckets_n - 1);
    abt_md::FGstatic *ret = _db.ind_gstatic_buckets_elems[index];
    for (; ret && !((*ret).field == key); ret = ret->ind_gstatic_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_gstatic.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FGstatic& abt_md::ind_gstatic_FindX(const algo::strptr& key) {
    abt_md::FGstatic* ret = ind_gstatic_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_gstatic  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_gstatic.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FGstatic& abt_md::ind_gstatic_GetOrCreate(const algo::strptr& key) {
    abt_md::FGstatic* ret = ind_gstatic_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &gstatic_Alloc();
        (*ret).field = key;
        bool good = gstatic_XrefMaybe(*ret);
        if (!good) {
            gstatic_RemoveLast(); // delete offending row, any existing xrefs are cleared
            ret = NULL;
        }
    }
    vrfy(ret, tempstr() << "abt_md.create_error  table:ind_gstatic  key:'"<<key<<"'  comment:'bad xref'");
    return *ret;
}

// --- abt_md.FDb.ind_gstatic.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_gstatic_InsertMaybe(abt_md::FGstatic& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_gstatic_next == (abt_md::FGstatic*)-1)) {// check if in hash already
        row.ind_gstatic_hashval = algo::Smallstr150_Hash(0, row.field);
        ind_gstatic_Reserve(1);
        u32 index = row.ind_gstatic_hashval & (_db.ind_gstatic_buckets_n - 1);
        abt_md::FGstatic* *prev = &_db.ind_gstatic_buckets_elems[index];
        do {
            abt_md::FGstatic* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
            if ((*ret).field == row.field) { // exit condition 2: found matching key
            ...
            prev = &ret->ind_gstatic_next;
        } while (true);
        if (retval) {
            row.ind_gstatic_next = *prev;
            _db.ind_gstatic_n++;
            *prev = &row;
        }
    }
...
// --- abt_md.FDb.ind_gstatic.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_gstatic_Remove(abt_md::FGstatic& row) {
    if (LIKELY(row.ind_gstatic_next != (abt_md::FGstatic*)-1)) {// check if in hash already
        u32 index = row.ind_gstatic_hashval & (_db.ind_gstatic_buckets_n - 1);
        abt_md::FGstatic* *prev = &_db.ind_gstatic_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FGstatic *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_gstatic_next; // unlink (singly linked list)
                _db.ind_gstatic_n--;
                row.ind_gstatic_next = (abt_md::FGstatic*)-1;// not-in-hash
                break;
            }
            prev = &next->ind_gstatic_next;
        }
    }
}

// --- abt_md.FDb.ind_gstatic.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_gstatic_Reserve(int n) {
    ind_gstatic_AbsReserve(_db.ind_gstatic_n + n);
}

// --- abt_md.FDb.ind_gstatic.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_gstatic_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_gstatic_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FGstatic*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FGstatic*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FGstatic* *new_buckets = (abt_md::FGstatic**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_gstatic");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_gstatic_buckets_n; i++) {
            abt_md::FGstatic* elem = _db.ind_gstatic_buckets_elems[i];
            while (elem) {
                abt_md::FGstatic &row        = *elem;
                abt_md::FGstatic* next       = row.ind_gstatic_next;
                u32 index          = row.ind_gstatic_hashval & (new_nbuckets-1);
                row.ind_gstatic_next     = new_buckets[index];
                new_buckets[index] = &row;
                elem               = next;
            }
        }
        // free old array
        algo_lib::malloc_FreeMem(_db.ind_gstatic_buckets_elems, old_size);
        _db.ind_gstatic_buckets_elems = new_buckets;
        _db.ind_gstatic_buckets_n = new_nbuckets;
    }
}

// --- abt_md.FDb.target.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FTarget& abt_md::target_Alloc() {
    abt_md::FTarget* row = target_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.target  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.target.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FTarget* abt_md::target_AllocMaybe() {
    abt_md::FTarget *row = (abt_md::FTarget*)target_AllocMem();
    if (row) {
        new (row) abt_md::FTarget; // call constructor
    }
    return row;
}

// --- abt_md.FDb.target.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FTarget* abt_md::target_InsertMaybe(const dev::Target &value) {
    abt_md::FTarget *row = &target_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.target.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::target_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FTarget*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.target_lary[bsr];
        if (!lev) {
            lev=(abt_md::FTarget*)algo_lib::malloc_AllocMem(sizeof(abt_md::FTarget) * (u64(1)<<bsr));
...
// --- abt_md.FDb.target.RemoveAll
// Remove all elements from Lary
void abt_md::target_RemoveAll() {
...
// --- abt_md.FDb.target.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::target_RemoveLast() {
    u64 n = _db.target_n;
    if (n > 0) {
        n -= 1;
...
// --- abt_md.FDb.target.InputMaybe
static bool abt_md::target_InputMaybe(dev::Target &elem) {
    bool retval = true;
    retval = target_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.target.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::target_XrefMaybe(abt_md::FTarget &row) {
    bool retval = true;
    (void)row;
    abt_md::FNs* p_target = abt_md::ind_ns_Find(row.target);
    if (UNLIKELY(!p_target)) {
        algo_lib::ResetErrtext() << "abt_md.bad_xref  index:abt_md.FDb.ind_ns" << Keyval("key", row.target);
        return false;
    }
    ...
    if (true) { // user-defined insert condition
        ...
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FNs.c_target"; // check for duplicate key
            return false;
        }
    }
    ...
    if (true) { // user-defined insert condition
        ...
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_target"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// --- abt_md.FDb.targdep.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FTargdep& abt_md::targdep_Alloc() {
    abt_md::FTargdep* row = targdep_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.targdep  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.targdep.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FTargdep* abt_md::targdep_AllocMaybe() {
    abt_md::FTargdep *row = (abt_md::FTargdep*)targdep_AllocMem();
    if (row) {
        new (row) abt_md::FTargdep; // call constructor
    }
    return row;
}

// --- abt_md.FDb.targdep.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FTargdep* abt_md::targdep_InsertMaybe(const dev::Targdep &value) {
    abt_md::FTargdep *row = &targdep_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.targdep.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::targdep_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FTargdep*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.targdep_lary[bsr];
        if (!lev) {
            lev=(abt_md::FTargdep*)algo_lib::malloc_AllocMem(sizeof(abt_md::FTargdep) * (u64(1)<<bsr));
...
// --- abt_md.FDb.targdep.RemoveAll
// Remove all elements from Lary
void abt_md::targdep_RemoveAll() {
...
// --- abt_md.FDb.targdep.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::targdep_RemoveLast() {
    u64 n = _db.targdep_n;
    if (n > 0) {
        n -= 1;
...
// --- abt_md.FDb.targdep.InputMaybe
static bool abt_md::targdep_InputMaybe(dev::Targdep &elem) {
    bool retval = true;
    retval = targdep_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.targdep.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::targdep_XrefMaybe(abt_md::FTargdep &row) {
    bool retval = true;
    (void)row;
    abt_md::FTarget* p_parent = abt_md::ind_target_Find(parent_Get(row));
    if (UNLIKELY(!p_parent)) {
        algo_lib::ResetErrtext() << "abt_md.bad_xref  index:abt_md.FDb.ind_target" << Keyval("key", parent_Get(row));
        return false;
    }
    ...
    abt_md::FTarget* p_target = abt_md::ind_target_Find(target_Get(row));
    if (UNLIKELY(!p_target)) {
        algo_lib::ResetErrtext() << "abt_md.bad_xref  index:abt_md.FDb.ind_target" << Keyval("key", target_Get(row));
        return false;
    }
...
// --- abt_md.FDb.ind_target.Find
// Find row by key. Return NULL if not found.
abt_md::FTarget* abt_md::ind_target_Find(const algo::strptr& key) {
    u32 index = algo::Smallstr16_Hash(0, key) & (_db.ind_target_buckets_n - 1);
    abt_md::FTarget *ret = _db.ind_target_buckets_elems[index];
    for (; ret && !((*ret).target == key); ret = ret->ind_target_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_target.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FTarget& abt_md::ind_target_FindX(const algo::strptr& key) {
    abt_md::FTarget* ret = ind_target_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_target  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_target.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FTarget* abt_md::ind_target_GetOrCreate(const algo::strptr& key) {
    abt_md::FTarget* ret = ind_target_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &target_Alloc();
        (*ret).target = key;
...
// --- abt_md.FDb.ind_target.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_target_InsertMaybe(abt_md::FTarget& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_target_next == (abt_md::FTarget*)-1)) {// check if in hash already
        ...
        abt_md::FTarget* *prev = &_db.ind_target_buckets_elems[index];
        do {
            abt_md::FTarget* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
...
// --- abt_md.FDb.ind_target.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_target_Remove(abt_md::FTarget& row) {
    if (LIKELY(row.ind_target_next != (abt_md::FTarget*)-1)) {// check if in hash already
        u32 index = row.ind_target_hashval & (_db.ind_target_buckets_n - 1);
        abt_md::FTarget* *prev = &_db.ind_target_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FTarget *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_target_next; // unlink (singly linked list)
                _db.ind_target_n--;
                row.ind_target_next = (abt_md::FTarget*)-1;// not-in-hash
                break;
            }
...
// --- abt_md.FDb.ind_target.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_target_Reserve(int n) {
    ind_target_AbsReserve(_db.ind_target_n + n);
}

// --- abt_md.FDb.ind_target.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_target_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_target_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FTarget*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FTarget*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FTarget* *new_buckets = (abt_md::FTarget**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_target");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_target_buckets_n; i++) {
            abt_md::FTarget* elem = _db.ind_target_buckets_elems[i];
            while (elem) {
                abt_md::FTarget &row        = *elem;
                abt_md::FTarget* next       = row.ind_target_next;
...
// --- abt_md.FDb.finput.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FFinput& abt_md::finput_Alloc() {
    abt_md::FFinput* row = finput_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.finput  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.finput.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FFinput* abt_md::finput_AllocMaybe() {
    abt_md::FFinput *row = (abt_md::FFinput*)finput_AllocMem();
    if (row) {
        new (row) abt_md::FFinput; // call constructor
    }
    return row;
}

// --- abt_md.FDb.finput.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FFinput* abt_md::finput_InsertMaybe(const dmmeta::Finput &value) {
    abt_md::FFinput *row = &finput_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.finput.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::finput_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FFinput*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.finput_lary[bsr];
        if (!lev) {
            lev=(abt_md::FFinput*)algo_lib::malloc_AllocMem(sizeof(abt_md::FFinput) * (u64(1)<<bsr));
...
// --- abt_md.FDb.finput.RemoveAll
// Remove all elements from Lary
void abt_md::finput_RemoveAll() {
...
// --- abt_md.FDb.finput.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::finput_RemoveLast() {
    u64 n = _db.finput_n;
    if (n > 0) {
        n -= 1;
...
// --- abt_md.FDb.finput.InputMaybe
static bool abt_md::finput_InputMaybe(dmmeta::Finput &elem) {
    bool retval = true;
    retval = finput_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.finput.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::finput_XrefMaybe(abt_md::FFinput &row) {
    bool retval = true;
    (void)row;
    abt_md::FField* p_field = abt_md::ind_field_Find(row.field);
    if (UNLIKELY(!p_field)) {
    ...
    // insert finput into index zd_finput
    if (true) { // user-defined insert condition
        zd_finput_Insert(*p_ns, row);
    }
    return retval;
}
...
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FDispatch& abt_md::dispatch_Alloc() {
    abt_md::FDispatch* row = dispatch_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.dispatch  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.dispatch.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FDispatch* abt_md::dispatch_AllocMaybe() {
    abt_md::FDispatch *row = (abt_md::FDispatch*)dispatch_AllocMem();
    if (row) {
        new (row) abt_md::FDispatch; // call constructor
    }
    return row;
}

// --- abt_md.FDb.dispatch.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FDispatch* abt_md::dispatch_InsertMaybe(const dmmeta::Dispatch &value) {
    abt_md::FDispatch *row = &dispatch_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.dispatch.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::dispatch_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FDispatch*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.dispatch_lary[bsr];
        if (!lev) {
            lev=(abt_md::FDispatch*)algo_lib::malloc_AllocMem(sizeof(abt_md::FDispatch) * (u64(1)<<bsr));
...
// --- abt_md.FDb.dispatch.RemoveAll
// Remove all elements from Lary
void abt_md::dispatch_RemoveAll() {
...
// --- abt_md.FDb.dispatch.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::dispatch_RemoveLast() {
...
// --- abt_md.FDb.dispatch.InputMaybe
static bool abt_md::dispatch_InputMaybe(dmmeta::Dispatch &elem) {
    bool retval = true;
    retval = dispatch_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.dispatch.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::dispatch_XrefMaybe(abt_md::FDispatch &row) {
    bool retval = true;
    (void)row;
    ...
    if (true) { // user-defined insert condition
        ...
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_dispatch"; // check for duplicate key
            return false;
        }
    }
    abt_md::FNs* p_ns = abt_md::ind_ns_Find(ns_Get(row));
...
// --- abt_md.FDb.ind_dispatch.Find
// Find row by key. Return NULL if not found.
abt_md::FDispatch* abt_md::ind_dispatch_Find(const algo::strptr& key) {
    u32 index = algo::Smallstr50_Hash(0, key) & (_db.ind_dispatch_buckets_n - 1);
    abt_md::FDispatch *ret = _db.ind_dispatch_buckets_elems[index];
    for (; ret && !((*ret).dispatch == key); ret = ret->ind_dispatch_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_dispatch.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FDispatch& abt_md::ind_dispatch_FindX(const algo::strptr& key) {
    abt_md::FDispatch* ret = ind_dispatch_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_dispatch  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_dispatch.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FDispatch* abt_md::ind_dispatch_GetOrCreate(const algo::strptr& key) {
    abt_md::FDispatch* ret = ind_dispatch_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &dispatch_Alloc();
        (*ret).dispatch = key;
...
// --- abt_md.FDb.ind_dispatch.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_dispatch_InsertMaybe(abt_md::FDispatch& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_dispatch_next == (abt_md::FDispatch*)-1)) {// check if in hash already
        ...
        abt_md::FDispatch* *prev = &_db.ind_dispatch_buckets_elems[index];
        do {
            abt_md::FDispatch* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
...
// --- abt_md.FDb.ind_dispatch.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_dispatch_Remove(abt_md::FDispatch& row) {
    if (LIKELY(row.ind_dispatch_next != (abt_md::FDispatch*)-1)) {// check if in hash already
        u32 index = row.ind_dispatch_hashval & (_db.ind_dispatch_buckets_n - 1);
        abt_md::FDispatch* *prev = &_db.ind_dispatch_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FDispatch *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_dispatch_next; // unlink (singly linked list)
                _db.ind_dispatch_n--;
                row.ind_dispatch_next = (abt_md::FDispatch*)-1;// not-in-hash
                break;
            }
...
// --- abt_md.FDb.ind_dispatch.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_dispatch_Reserve(int n) {
    ind_dispatch_AbsReserve(_db.ind_dispatch_n + n);
}

// --- abt_md.FDb.ind_dispatch.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_dispatch_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_dispatch_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FDispatch*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FDispatch*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FDispatch* *new_buckets = (abt_md::FDispatch**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_dispatch");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_dispatch_buckets_n; i++) {
            abt_md::FDispatch* elem = _db.ind_dispatch_buckets_elems[i];
            while (elem) {
                abt_md::FDispatch &row        = *elem;
                abt_md::FDispatch* next       = row.ind_dispatch_next;
...
// --- abt_md.FDb.dispatch_msg.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FDispatchMsg& abt_md::dispatch_msg_Alloc() {
    abt_md::FDispatchMsg* row = dispatch_msg_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.dispatch_msg  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.dispatch_msg.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FDispatchMsg* abt_md::dispatch_msg_AllocMaybe() {
    abt_md::FDispatchMsg *row = (abt_md::FDispatchMsg*)dispatch_msg_AllocMem();
    if (row) {
        new (row) abt_md::FDispatchMsg; // call constructor
    }
    return row;
}

// --- abt_md.FDb.dispatch_msg.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FDispatchMsg* abt_md::dispatch_msg_InsertMaybe(const dmmeta::DispatchMsg &value) {
    abt_md::FDispatchMsg *row = &dispatch_msg_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.dispatch_msg.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::dispatch_msg_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FDispatchMsg*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.dispatch_msg_lary[bsr];
        if (!lev) {
            lev=(abt_md::FDispatchMsg*)algo_lib::malloc_AllocMem(sizeof(abt_md::FDispatchMsg) * (u64(1)<<bsr));
...
// --- abt_md.FDb.dispatch_msg.RemoveAll
// Remove all elements from Lary
void abt_md::dispatch_msg_RemoveAll() {
...
// --- abt_md.FDb.dispatch_msg.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::dispatch_msg_RemoveLast() {
...
// --- abt_md.FDb.dispatch_msg.InputMaybe
static bool abt_md::dispatch_msg_InputMaybe(dmmeta::DispatchMsg &elem) {
    bool retval = true;
    retval = dispatch_msg_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.dispatch_msg.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::dispatch_msg_XrefMaybe(abt_md::FDispatchMsg &row) {
    bool retval = true;
    (void)row;
    abt_md::FCtype* p_ctype = abt_md::ind_ctype_Find(ctype_Get(row));
    if (UNLIKELY(!p_ctype)) {
    ...
    abt_md::FDispatch* p_dispatch = abt_md::ind_dispatch_Find(dispatch_Get(row));
    if (UNLIKELY(!p_dispatch)) {
        algo_lib::ResetErrtext() << "abt_md.bad_xref  index:abt_md.FDb.ind_dispatch" << Keyval("key", dispatch_Get(row));
        return false;
    }
...
// --- abt_md.FDb.ind_checkreq.Find
// Find row by key. Return NULL if not found.
abt_md::FCheckReq* abt_md::ind_checkreq_Find(u32 key) {
    u32 index = ::u32_Hash(0, key) & (_db.ind_checkreq_buckets_n - 1);
    abt_md::FCheckReq *ret = _db.ind_checkreq_buckets_elems[index];
    for (; ret && !((*ret).id == key); ret = ret->ind_checkreq_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_checkreq.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FCheckReq& abt_md::ind_checkreq_FindX(u32 key) {
    abt_md::FCheckReq* ret = ind_checkreq_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_checkreq  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_checkreq.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FCheckReq& abt_md::ind_checkreq_GetOrCreate(u32 key) {
    abt_md::FCheckReq* ret = ind_checkreq_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &checkreq_Alloc();
        (*ret).id = key;
        bool good = checkreq_XrefMaybe(*ret);
        if (!good) {
            checkreq_RemoveLast(); // delete offending row, any existing xrefs are cleared
            ret = NULL;
        }
    }
    vrfy(ret, tempstr() << "abt_md.create_error  table:ind_checkreq  key:'"<<key<<"'  comment:'bad xref'");
    return *ret;
}

// --- abt_md.FDb.ind_checkreq.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_checkreq_InsertMaybe(abt_md::FCheckReq& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_checkreq_next == (abt_md::FCheckReq*)-1)) {// check if in hash already
        row.ind_checkreq_hashval = ::u32_Hash(0, row.id);
        ind_checkreq_Reserve(1);
        u32 index = row.ind_checkreq_hashval & (_db.ind_checkreq_buckets_n - 1);
        abt_md::FCheckReq* *prev = &_db.ind_checkreq_buckets_elems[index];
        do {
            abt_md::FCheckReq* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
            if ((*ret).id == row.id) { // exit condition 2: found matching key
                retval = false;
                break;
            }
            prev = &ret->ind_checkreq_next;
        } while (true);
        if (retval) {
            row.ind_checkreq_next = *prev;
            _db.ind_checkreq_n++;
            *prev = &row;
        }
    }
...
// --- abt_md.FDb.ind_checkreq.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_checkreq_Remove(abt_md::FCheckReq& row) {
    if (LIKELY(row.ind_checkreq_next != (abt_md::FCheckReq*)-1)) {// check if in hash already
        u32 index = row.ind_checkreq_hashval & (_db.ind_checkreq_buckets_n - 1);
        abt_md::FCheckReq* *prev = &_db.ind_checkreq_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FCheckReq *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_checkreq_next; // unlink (singly linked list)
                _db.ind_checkreq_n--;
                row.ind_checkreq_next = (abt_md::FCheckReq*)-1;// not-in-hash
                break;
            }
            prev = &next->ind_checkreq_next;
        }
    }
}

// --- abt_md.FDb.ind_checkreq.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_checkreq_Reserve(int n) {
    ind_checkreq_AbsReserve(_db.ind_checkreq_n + n);
}

// --- abt_md.FDb.ind_checkreq.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_checkreq_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_checkreq_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FCheckReq*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FCheckReq*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FCheckReq* *new_buckets = (abt_md::FCheckReq**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_checkreq");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_checkreq_buckets_n; i++) {
            abt_md::FCheckReq* elem = _db.ind_checkreq_buckets_elems[i];
            while (elem) {
                abt_md::FCheckReq &row        = *elem;
                abt_md::FCheckReq* next       = row.ind_checkreq_next;
                u32 index          = row.ind_checkreq_hashval & (new_nbuckets-1);
                row.ind_checkreq_next     = new_buckets[index];
                new_buckets[index] = &row;
                elem               = next;
            }
        }
        // free old array
        algo_lib::malloc_FreeMem(_db.ind_checkreq_buckets_elems, old_size);
        _db.ind_checkreq_buckets_elems = new_buckets;
        _db.ind_checkreq_buckets_n = new_nbuckets;
    }
}

// --- abt_md.FDb.checkreq.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FCheckReq& abt_md::checkreq_Alloc() {
    abt_md::FCheckReq* row = checkreq_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.checkreq  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.checkreq.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FCheckReq* abt_md::checkreq_AllocMaybe() {
    abt_md::FCheckReq *row = (abt_md::FCheckReq*)checkreq_AllocMem();
    if (row) {
        new (row) abt_md::FCheckReq; // call constructor
    }
    return row;
}

// --- abt_md.FDb.checkreq.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::checkreq_AllocMem() {
    u64 new_nelems     = _db.checkreq_n+1;
    // compute level and index on level
    u64 bsr   = algo::u64_BitScanReverse(new_nelems);
    u64 base  = u64(1)<<bsr;
    u64 index = new_nelems-base;
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FCheckReq*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.checkreq_lary[bsr];
        if (!lev) {
            lev=(abt_md::FCheckReq*)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckReq) * (u64(1)<<bsr));
            _db.checkreq_lary[bsr] = lev;
        }
    }
    // allocate element from this level
    if (lev) {
        _db.checkreq_n = i64(new_nelems);
        ret = lev + index;
    }
    return ret;
}

// --- abt_md.FDb.checkreq.RemoveAll
// Remove all elements from Lary
void abt_md::checkreq_RemoveAll() {
    for (u64 n = _db.checkreq_n; n>0; ) {
        n--;
        checkreq_qFind(u64(n)).~FCheckReq(); // destroy last element
        _db.checkreq_n = i64(n);
    }
}

// --- abt_md.FDb.checkreq.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::checkreq_RemoveLast() {
    u64 n = _db.checkreq_n;
    if (n > 0) {
        n -= 1;
        checkreq_qFind(u64(n)).~FCheckReq();
        _db.checkreq_n = i64(n);
    }
}

// --- abt_md.FDb.checkreq.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::checkreq_XrefMaybe(abt_md::FCheckReq &row) {
    bool retval = true;
    (void)row;
    // insert checkreq into index ind_checkreq
    if (true) { // user-defined insert condition
        bool success = ind_checkreq_InsertMaybe(row);
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_checkreq"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FCheckKey& abt_md::checkkey_Alloc() {
    abt_md::FCheckKey* row = checkkey_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.checkkey  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.checkkey.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FCheckKey* abt_md::checkkey_AllocMaybe() {
    abt_md::FCheckKey *row = (abt_md::FCheckKey*)checkkey_AllocMem();
    if (row) {
        new (row) abt_md::FCheckKey; // call constructor
    }
    return row;
}

// --- abt_md.FDb.checkkey.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::checkkey_AllocMem() {
    u64 new_nelems     = _db.checkkey_n+1;
    // compute level and index on level
    u64 bsr   = algo::u64_BitScanReverse(new_nelems);
    u64 base  = u64(1)<<bsr;
    u64 index = new_nelems-base;
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FCheckKey*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.checkkey_lary[bsr];
        if (!lev) {
            lev=(abt_md::FCheckKey*)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckKey) * (u64(1)<<bsr));
            _db.checkkey_lary[bsr] = lev;
        }
    }
    // allocate element from this level
    if (lev) {
        _db.checkkey_n = i64(new_nelems);
        ret = lev + index;
    }
    return ret;
}

// --- abt_md.FDb.checkkey.RemoveAll
// Remove all elements from Lary
void abt_md::checkkey_RemoveAll() {
    for (u64 n = _db.checkkey_n; n>0; ) {
        n--;
        checkkey_qFind(u64(n)).~FCheckKey(); // destroy last element
        _db.checkkey_n = i64(n);
    }
}

// --- abt_md.FDb.checkkey.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::checkkey_RemoveLast() {
    u64 n = _db.checkkey_n;
    if (n > 0) {
        n -= 1;
        checkkey_qFind(u64(n)).~FCheckKey();
        _db.checkkey_n = i64(n);
    }
}

// --- abt_md.FDb.checkkey.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::checkkey_XrefMaybe(abt_md::FCheckKey &row) {
    bool retval = true;
    (void)row;
    // insert checkkey into index ind_checkkey
    if (true) { // user-defined insert condition
        bool success = ind_checkkey_InsertMaybe(row);
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_checkkey"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// --- abt_md.FDb.ind_checkkey.Find
// Find row by key. Return NULL if not found.
abt_md::FCheckKey* abt_md::ind_checkkey_Find(const algo::strptr& key) {
    u32 index = algo::cstring_Hash(0, key) & (_db.ind_checkkey_buckets_n - 1);
    abt_md::FCheckKey *ret = _db.ind_checkkey_buckets_elems[index];
    for (; ret && !((*ret).key == key); ret = ret->ind_checkkey_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_checkkey.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FCheckKey& abt_md::ind_checkkey_FindX(const algo::strptr& key) {
    abt_md::FCheckKey* ret = ind_checkkey_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_checkkey  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_checkkey.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FCheckKey& abt_md::ind_checkkey_GetOrCreate(const algo::strptr& key) {
    abt_md::FCheckKey* ret = ind_checkkey_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &checkkey_Alloc();
        (*ret).key = key;
        bool good = checkkey_XrefMaybe(*ret);
        if (!good) {
            checkkey_RemoveLast(); // delete offending row, any existing xrefs are cleared
            ret = NULL;
        }
    }
    vrfy(ret, tempstr() << "abt_md.create_error  table:ind_checkkey  key:'"<<key<<"'  comment:'bad xref'");
    return *ret;
}

// --- abt_md.FDb.ind_checkkey.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_checkkey_InsertMaybe(abt_md::FCheckKey& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_checkkey_next == (abt_md::FCheckKey*)-1)) {// check if in hash already
        row.ind_checkkey_hashval = algo::cstring_Hash(0, row.key);
        ind_checkkey_Reserve(1);
        u32 index = row.ind_checkkey_hashval & (_db.ind_checkkey_buckets_n - 1);
        abt_md::FCheckKey* *prev = &_db.ind_checkkey_buckets_elems[index];
        do {
            abt_md::FCheckKey* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
            if ((*ret).key == row.key) { // exit condition 2: found matching key
            ...
            prev = &ret->ind_checkkey_next;
        } while (true);
        if (retval) {
            row.ind_checkkey_next = *prev;
            _db.ind_checkkey_n++;
            *prev = &row;
        }
    }
...
// --- abt_md.FDb.ind_checkkey.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_checkkey_Remove(abt_md::FCheckKey& row) {
    if (LIKELY(row.ind_checkkey_next != (abt_md::FCheckKey*)-1)) {// check if in hash already
        u32 index = row.ind_checkkey_hashval & (_db.ind_checkkey_buckets_n - 1);
        abt_md::FCheckKey* *prev = &_db.ind_checkkey_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FCheckKey *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_checkkey_next; // unlink (singly linked list)
                _db.ind_checkkey_n--;
                row.ind_checkkey_next = (abt_md::FCheckKey*)-1;// not-in-hash
                break;
            }
            prev = &next->ind_checkkey_next;
        }
    }
}

// --- abt_md.FDb.ind_checkkey.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_checkkey_Reserve(int n) {
    ind_checkkey_AbsReserve(_db.ind_checkkey_n + n);
}

// --- abt_md.FDb.ind_checkkey.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_checkkey_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_checkkey_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FCheckKey*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FCheckKey*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FCheckKey* *new_buckets = (abt_md::FCheckKey**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_checkkey");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_checkkey_buckets_n; i++) {
            abt_md::FCheckKey* elem = _db.ind_checkkey_buckets_elems[i];
            while (elem) {
                abt_md::FCheckKey &row        = *elem;
                abt_md::FCheckKey* next       = row.ind_checkkey_next;
                u32 index          = row.ind_checkkey_hashval & (new_nbuckets-1);
                row.ind_checkkey_next     = new_buckets[index];
                new_buckets[index] = &row;
                elem               = next;
            }
        }
        // free old array
        algo_lib::malloc_FreeMem(_db.ind_checkkey_buckets_elems, old_size);
        _db.ind_checkkey_buckets_elems = new_buckets;
        _db.ind_checkkey_buckets_n = new_nbuckets;
    }
}

// --- abt_md.FDb.gitfile.Alloc
// Allocate memory for new default row.
// If out of memory, process is killed.
abt_md::FGitfile& abt_md::gitfile_Alloc() {
    abt_md::FGitfile* row = gitfile_AllocMaybe();
    if (UNLIKELY(row == NULL)) {
        FatalErrorExit("abt_md.out_of_mem  field:abt_md.FDb.gitfile  comment:'Alloc failed'");
    }
    return *row;
}

// --- abt_md.FDb.gitfile.AllocMaybe
// Allocate memory for new element. If out of memory, return NULL.
abt_md::FGitfile* abt_md::gitfile_AllocMaybe() {
    abt_md::FGitfile *row = (abt_md::FGitfile*)gitfile_AllocMem();
    if (row) {
        new (row) abt_md::FGitfile; // call constructor
    }
    return row;
}

// --- abt_md.FDb.gitfile.InsertMaybe
// Create new row from struct.
// Return pointer to new element, or NULL if insertion failed (due to out-of-memory, duplicate key, etc)
abt_md::FGitfile* abt_md::gitfile_InsertMaybe(const dev::Gitfile &value) {
    abt_md::FGitfile *row = &gitfile_Alloc(); // if out of memory, process dies. if input error, return NULL.
...
// --- abt_md.FDb.gitfile.AllocMem
// Allocate space for one element. If no memory available, return NULL.
void* abt_md::gitfile_AllocMem() {
    ...
    void *ret = NULL;
    // if level doesn't exist yet, create it
    abt_md::FGitfile*  lev   = NULL;
    if (bsr < 36) {
        lev = _db.gitfile_lary[bsr];
        if (!lev) {
            lev=(abt_md::FGitfile*)algo_lib::malloc_AllocMem(sizeof(abt_md::FGitfile) * (u64(1)<<bsr));
...
// --- abt_md.FDb.gitfile.RemoveAll
// Remove all elements from Lary
void abt_md::gitfile_RemoveAll() {
...
// --- abt_md.FDb.gitfile.RemoveLast
// Delete last element of array. Do nothing if array is empty.
void abt_md::gitfile_RemoveLast() {
    u64 n = _db.gitfile_n;
    if (n > 0) {
        n -= 1;
...
// --- abt_md.FDb.gitfile.InputMaybe
static bool abt_md::gitfile_InputMaybe(dev::Gitfile &elem) {
    bool retval = true;
    retval = gitfile_InsertMaybe(elem) != nullptr;
    return retval;
}

// --- abt_md.FDb.gitfile.XrefMaybe
// Insert row into all appropriate indices. If error occurs, store error
// in algo_lib::_db.errtext and return false. Caller must Delete or Unref such row.
bool abt_md::gitfile_XrefMaybe(abt_md::FGitfile &row) {
    bool retval = true;
    (void)row;
    ...
    if (true) { // user-defined insert condition
        ...
        if (UNLIKELY(!success)) {
            ch_RemoveAll(algo_lib::_db.errtext);
            algo_lib::_db.errtext << "abt_md.duplicate_key  xref:abt_md.FDb.ind_gitfile"; // check for duplicate key
            return false;
        }
    }
    return retval;
...
// --- abt_md.FDb.ind_gitfile.Find
// Find row by key. Return NULL if not found.
abt_md::FGitfile* abt_md::ind_gitfile_Find(const algo::strptr& key) {
    u32 index = algo::Smallstr200_Hash(0, key) & (_db.ind_gitfile_buckets_n - 1);
    abt_md::FGitfile *ret = _db.ind_gitfile_buckets_elems[index];
    for (; ret && !((*ret).gitfile == key); ret = ret->ind_gitfile_next) {
    }
    return ret;
}

// --- abt_md.FDb.ind_gitfile.FindX
// Look up row by key and return reference. Throw exception if not found
abt_md::FGitfile& abt_md::ind_gitfile_FindX(const algo::strptr& key) {
    abt_md::FGitfile* ret = ind_gitfile_Find(key);
    vrfy(ret, tempstr() << "abt_md.key_error  table:ind_gitfile  key:'"<<key<<"'  comment:'key not found'");
    return *ret;
}

// --- abt_md.FDb.ind_gitfile.GetOrCreate
// Find row by key. If not found, create and x-reference a new row with with this key.
abt_md::FGitfile& abt_md::ind_gitfile_GetOrCreate(const algo::strptr& key) {
    abt_md::FGitfile* ret = ind_gitfile_Find(key);
    if (!ret) { //  if memory alloc fails, process dies; if insert fails, function returns NULL.
        ret         = &gitfile_Alloc();
        (*ret).gitfile = key;
    ...
    vrfy(ret, tempstr() << "abt_md.create_error  table:ind_gitfile  key:'"<<key<<"'  comment:'bad xref'");
    return *ret;
}

// --- abt_md.FDb.ind_gitfile.InsertMaybe
// Insert row into hash table. Return true if row is reachable through the hash after the function completes.
bool abt_md::ind_gitfile_InsertMaybe(abt_md::FGitfile& row) {
    bool retval = true; // if already in hash, InsertMaybe returns true
    if (LIKELY(row.ind_gitfile_next == (abt_md::FGitfile*)-1)) {// check if in hash already
        ...
        abt_md::FGitfile* *prev = &_db.ind_gitfile_buckets_elems[index];
        do {
            abt_md::FGitfile* ret = *prev;
            if (!ret) { // exit condition 1: reached the end of the list
                break;
            }
            if ((*ret).gitfile == row.gitfile) { // exit condition 2: found matching key
...
// --- abt_md.FDb.ind_gitfile.Remove
// Remove reference to element from hash index. If element is not in hash, do nothing
void abt_md::ind_gitfile_Remove(abt_md::FGitfile& row) {
    if (LIKELY(row.ind_gitfile_next != (abt_md::FGitfile*)-1)) {// check if in hash already
        u32 index = row.ind_gitfile_hashval & (_db.ind_gitfile_buckets_n - 1);
        abt_md::FGitfile* *prev = &_db.ind_gitfile_buckets_elems[index]; // addr of pointer to current element
        while (abt_md::FGitfile *next = *prev) {                          // scan the collision chain for our element
            if (next == &row) {        // found it?
                *prev = next->ind_gitfile_next; // unlink (singly linked list)
                _db.ind_gitfile_n--;
                row.ind_gitfile_next = (abt_md::FGitfile*)-1;// not-in-hash
                break;
            }
...
// --- abt_md.FDb.ind_gitfile.Reserve
// Reserve enough room in the hash for N more elements. Return success code.
void abt_md::ind_gitfile_Reserve(int n) {
    ind_gitfile_AbsReserve(_db.ind_gitfile_n + n);
}

// --- abt_md.FDb.ind_gitfile.AbsReserve
// Reserve enough room for exacty N elements. Return success code.
void abt_md::ind_gitfile_AbsReserve(int n) {
    u32 old_nbuckets = _db.ind_gitfile_buckets_n;
    u32 new_nelems   = n;
    // # of elements has to be roughly equal to the number of buckets
    if (new_nelems > old_nbuckets) {
        int new_nbuckets = i32_Max(algo::BumpToPow2(new_nelems), u32(4));
        u32 old_size = old_nbuckets * sizeof(abt_md::FGitfile*);
        u32 new_size = new_nbuckets * sizeof(abt_md::FGitfile*);
        // allocate new array. we don't use Realloc since copying is not needed and factor of 2 probably
        // means new memory will have to be allocated anyway
        abt_md::FGitfile* *new_buckets = (abt_md::FGitfile**)algo_lib::malloc_AllocMem(new_size);
        if (UNLIKELY(!new_buckets)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDb.ind_gitfile");
        }
        memset(new_buckets, 0, new_size); // clear pointers
        // rehash all entries
        for (int i = 0; i < _db.ind_gitfile_buckets_n; i++) {
            abt_md::FGitfile* elem = _db.ind_gitfile_buckets_elems[i];
            while (elem) {
                abt_md::FGitfile &row        = *elem;
                abt_md::FGitfile* next       = row.ind_gitfile_next;
...
void abt_md::FDb_Init() {
    // initialize LAry readmefile (abt_md.FDb.readmefile)
    _db.readmefile_n = 0;
    memset(_db.readmefile_lary, 0, sizeof(_db.readmefile_lary)); // zero out all level pointers
    abt_md::FReadmefile* readmefile_first = (abt_md::FReadmefile*)algo_lib::malloc_AllocMem(sizeof(abt_md::FReadmefile) * (u64(1)<<4));
    if (!readmefile_first) {
    ...
    // initialize hash table for abt_md::FReadmefile;
    _db.ind_readmefile_n             	= 0; // (abt_md.FDb.ind_readmefile)
    _db.ind_readmefile_buckets_n     	= 4; // (abt_md.FDb.ind_readmefile)
    _db.ind_readmefile_buckets_elems 	= (abt_md::FReadmefile**)algo_lib::malloc_AllocMem(sizeof(abt_md::FReadmefile*)*_db.ind_readmefile_buckets_n); // initial buckets (abt_md.FDb.ind_readmefile)
    if (!_db.ind_readmefile_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_readmefile)
    }
    memset(_db.ind_readmefile_buckets_elems, 0, sizeof(abt_md::FReadmefile*)*_db.ind_readmefile_buckets_n); // (abt_md.FDb.ind_readmefile)
    ...
    abt_md::FGstatic* gstatic_first = (abt_md::FGstatic*)algo_lib::malloc_AllocMem(sizeof(abt_md::FGstatic) * (u64(1)<<4));
    if (!gstatic_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    // initialize hash table for abt_md::FGstatic;
    _db.ind_gstatic_n             	= 0; // (abt_md.FDb.ind_gstatic)
    _db.ind_gstatic_buckets_n     	= 4; // (abt_md.FDb.ind_gstatic)
    _db.ind_gstatic_buckets_elems 	= (abt_md::FGstatic**)algo_lib::malloc_AllocMem(sizeof(abt_md::FGstatic*)*_db.ind_gstatic_buckets_n); // initial buckets (abt_md.FDb.ind_gstatic)
    if (!_db.ind_gstatic_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_gstatic)
    }
    memset(_db.ind_gstatic_buckets_elems, 0, sizeof(abt_md::FGstatic*)*_db.ind_gstatic_buckets_n); // (abt_md.FDb.ind_gstatic)
    // initialize LAry target (abt_md.FDb.target)
    _db.target_n = 0;
    memset(_db.target_lary, 0, sizeof(_db.target_lary)); // zero out all level pointers
    abt_md::FTarget* target_first = (abt_md::FTarget*)algo_lib::malloc_AllocMem(sizeof(abt_md::FTarget) * (u64(1)<<4));
    if (!target_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    // initialize LAry targdep (abt_md.FDb.targdep)
    _db.targdep_n = 0;
    memset(_db.targdep_lary, 0, sizeof(_db.targdep_lary)); // zero out all level pointers
    abt_md::FTargdep* targdep_first = (abt_md::FTargdep*)algo_lib::malloc_AllocMem(sizeof(abt_md::FTargdep) * (u64(1)<<4));
    if (!targdep_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    // initialize hash table for abt_md::FTarget;
    _db.ind_target_n             	= 0; // (abt_md.FDb.ind_target)
    _db.ind_target_buckets_n     	= 4; // (abt_md.FDb.ind_target)
    _db.ind_target_buckets_elems 	= (abt_md::FTarget**)algo_lib::malloc_AllocMem(sizeof(abt_md::FTarget*)*_db.ind_target_buckets_n); // initial buckets (abt_md.FDb.ind_target)
    if (!_db.ind_target_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_target)
    }
    memset(_db.ind_target_buckets_elems, 0, sizeof(abt_md::FTarget*)*_db.ind_target_buckets_n); // (abt_md.FDb.ind_target)
    // initialize LAry finput (abt_md.FDb.finput)
    _db.finput_n = 0;
    memset(_db.finput_lary, 0, sizeof(_db.finput_lary)); // zero out all level pointers
    abt_md::FFinput* finput_first = (abt_md::FFinput*)algo_lib::malloc_AllocMem(sizeof(abt_md::FFinput) * (u64(1)<<4));
    if (!finput_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    abt_md::FDispatch* dispatch_first = (abt_md::FDispatch*)algo_lib::malloc_AllocMem(sizeof(abt_md::FDispatch) * (u64(1)<<4));
    if (!dispatch_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    // initialize hash table for abt_md::FDispatch;
    _db.ind_dispatch_n             	= 0; // (abt_md.FDb.ind_dispatch)
    _db.ind_dispatch_buckets_n     	= 4; // (abt_md.FDb.ind_dispatch)
    _db.ind_dispatch_buckets_elems 	= (abt_md::FDispatch**)algo_lib::malloc_AllocMem(sizeof(abt_md::FDispatch*)*_db.ind_dispatch_buckets_n); // initial buckets (abt_md.FDb.ind_dispatch)
    if (!_db.ind_dispatch_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_dispatch)
    }
    memset(_db.ind_dispatch_buckets_elems, 0, sizeof(abt_md::FDispatch*)*_db.ind_dispatch_buckets_n); // (abt_md.FDb.ind_dispatch)
    // initialize LAry dispatch_msg (abt_md.FDb.dispatch_msg)
    _db.dispatch_msg_n = 0;
    memset(_db.dispatch_msg_lary, 0, sizeof(_db.dispatch_msg_lary)); // zero out all level pointers
    abt_md::FDispatchMsg* dispatch_msg_first = (abt_md::FDispatchMsg*)algo_lib::malloc_AllocMem(sizeof(abt_md::FDispatchMsg) * (u64(1)<<4));
    ...
    _db.help_loaded = bool(false);
    _db.next_checkid = u32(0);
    // initialize hash table for abt_md::FCheckReq;
    _db.ind_checkreq_n             	= 0; // (abt_md.FDb.ind_checkreq)
    _db.ind_checkreq_buckets_n     	= 4; // (abt_md.FDb.ind_checkreq)
    _db.ind_checkreq_buckets_elems 	= (abt_md::FCheckReq**)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckReq*)*_db.ind_checkreq_buckets_n); // initial buckets (abt_md.FDb.ind_checkreq)
    if (!_db.ind_checkreq_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_checkreq)
    }
    memset(_db.ind_checkreq_buckets_elems, 0, sizeof(abt_md::FCheckReq*)*_db.ind_checkreq_buckets_n); // (abt_md.FDb.ind_checkreq)
    // initialize LAry checkreq (abt_md.FDb.checkreq)
    _db.checkreq_n = 0;
    memset(_db.checkreq_lary, 0, sizeof(_db.checkreq_lary)); // zero out all level pointers
    abt_md::FCheckReq* checkreq_first = (abt_md::FCheckReq*)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckReq) * (u64(1)<<4));
    if (!checkreq_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
        _db.checkreq_lary[i]  = checkreq_first;
    ...
    abt_md::FCheckKey* checkkey_first = (abt_md::FCheckKey*)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckKey) * (u64(1)<<4));
    if (!checkkey_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
        _db.checkkey_lary[i]  = checkkey_first;
        checkkey_first    += 1ULL<<i;
    }
    // initialize hash table for abt_md::FCheckKey;
    _db.ind_checkkey_n             	= 0; // (abt_md.FDb.ind_checkkey)
    _db.ind_checkkey_buckets_n     	= 4; // (abt_md.FDb.ind_checkkey)
    _db.ind_checkkey_buckets_elems 	= (abt_md::FCheckKey**)algo_lib::malloc_AllocMem(sizeof(abt_md::FCheckKey*)*_db.ind_checkkey_buckets_n); // initial buckets (abt_md.FDb.ind_checkkey)
    if (!_db.ind_checkkey_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_checkkey)
    }
    memset(_db.ind_checkkey_buckets_elems, 0, sizeof(abt_md::FCheckKey*)*_db.ind_checkkey_buckets_n); // (abt_md.FDb.ind_checkkey)
    // initialize LAry gitfile (abt_md.FDb.gitfile)
    _db.gitfile_n = 0;
    memset(_db.gitfile_lary, 0, sizeof(_db.gitfile_lary)); // zero out all level pointers
    abt_md::FGitfile* gitfile_first = (abt_md::FGitfile*)algo_lib::malloc_AllocMem(sizeof(abt_md::FGitfile) * (u64(1)<<4));
    if (!gitfile_first) {
        FatalErrorExit("out of memory");
    }
    for (int i = 0; i < 4; i++) {
    ...
    // initialize hash table for abt_md::FGitfile;
    _db.ind_gitfile_n             	= 0; // (abt_md.FDb.ind_gitfile)
    _db.ind_gitfile_buckets_n     	= 4; // (abt_md.FDb.ind_gitfile)
    _db.ind_gitfile_buckets_elems 	= (abt_md::FGitfile**)algo_lib::malloc_AllocMem(sizeof(abt_md::FGitfile*)*_db.ind_gitfile_buckets_n); // initial buckets (abt_md.FDb.ind_gitfile)
    if (!_db.ind_gitfile_buckets_elems) {
        FatalErrorExit("out of memory"); // (abt_md.FDb.ind_gitfile)
    }
    memset(_db.ind_gitfile_buckets_elems, 0, sizeof(abt_md::FGitfile*)*_db.ind_gitfile_buckets_n); // (abt_md.FDb.ind_gitfile)
...
void abt_md::FDb_Uninit() {
    ...
    // abt_md.FDb.ind_gitfile.Uninit (Thash)  //
    // skip destruction of ind_gitfile in global scope

    // abt_md.FDb.gitfile.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.ind_checkkey.Uninit (Thash)  //
    // skip destruction of ind_checkkey in global scope
    ...
    // abt_md.FDb.ind_checkreq.Uninit (Thash)  //
    // skip destruction of ind_checkreq in global scope

    // abt_md.FDb.dispatch_msg.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.ind_dispatch.Uninit (Thash)  //
    // skip destruction of ind_dispatch in global scope

    // abt_md.FDb.dispatch.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.finput.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.ind_target.Uninit (Thash)  //
    // skip destruction of ind_target in global scope

    // abt_md.FDb.targdep.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.target.Uninit (Lary)  //
    // skip destruction in global scope

    // abt_md.FDb.ind_gstatic.Uninit (Thash)  //
    ...
    // abt_md.FDb.ind_readmefile.Uninit (Thash)  //
...
// Copy fields out of row
void abt_md::dispatch_CopyOut(abt_md::FDispatch &row, dmmeta::Dispatch &out) {
...
// --- abt_md.FDispatch.base.CopyIn
// Copy fields in to row
void abt_md::dispatch_CopyIn(abt_md::FDispatch &row, dmmeta::Dispatch &in) {
...
// --- abt_md.FDispatch.ns.Get
algo::strptr abt_md::ns_Get(abt_md::FDispatch& parent) {
    return algo::Pathcomp(parent.dispatch, ".RL");
}

// --- abt_md.FDispatch.name.Get
algo::strptr abt_md::name_Get(abt_md::FDispatch& parent) {
    return algo::Pathcomp(parent.dispatch, ".RR");
}

// --- abt_md.FDispatch.c_dispatch_msg.Insert
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_dispatch_msg_Insert(abt_md::FDispatch& parent, abt_md::FDispatchMsg& row) {
    if (!row.dispatch_c_dispatch_msg_in_ary) {
        c_dispatch_msg_Reserve(parent, 1);
        u64 n  = parent.c_dispatch_msg_n++;
        parent.c_dispatch_msg_elems[n] = &row;
        row.dispatch_c_dispatch_msg_in_ary = true;
    }
}

// --- abt_md.FDispatch.c_dispatch_msg.InsertMaybe
// Insert pointer to row in array.
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_dispatch_msg_InsertMaybe(abt_md::FDispatch& parent, abt_md::FDispatchMsg& row) {
    bool retval = !dispatch_c_dispatch_msg_InAryQ(row);
    c_dispatch_msg_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FDispatch.c_dispatch_msg.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_dispatch_msg_Remove(abt_md::FDispatch& parent, abt_md::FDispatchMsg& row) {
    i64 n = parent.c_dispatch_msg_n;
    if (bool_Update(row.dispatch_c_dispatch_msg_in_ary,false)) {
        abt_md::FDispatchMsg* *elems = parent.c_dispatch_msg_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            abt_md::FDispatchMsg* elem = elems[i]; // fetch element
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FDispatchMsg*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
                parent.c_dispatch_msg_n = n - 1;
                break;
            }
        }
    }
...
// --- abt_md.FDispatch.c_dispatch_msg.Reserve
// Reserve space in index for N more elements;
void abt_md::c_dispatch_msg_Reserve(abt_md::FDispatch& parent, u64 n) {
    u64 old_max = parent.c_dispatch_msg_max;
    if (UNLIKELY(parent.c_dispatch_msg_n + n > old_max)) {
        u64 new_max  = u64_Max(u64_Max(old_max * 2, parent.c_dispatch_msg_n + n), 4);
        u64 old_size = old_max * sizeof(abt_md::FDispatchMsg*);
        u64 new_size = new_max * sizeof(abt_md::FDispatchMsg*);
        void *new_mem = algo_lib::malloc_ReallocMem(parent.c_dispatch_msg_elems, old_size, new_size);
        if (UNLIKELY(!new_mem)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FDispatch.c_dispatch_msg");
        }
        parent.c_dispatch_msg_elems = (abt_md::FDispatchMsg**)new_mem;
        parent.c_dispatch_msg_max = new_max;
    }
}

// --- abt_md.FDispatch..Init
// Set all fields to initial values.
void abt_md::FDispatch_Init(abt_md::FDispatch& parent) {
    ...
    parent.c_dispatch_msg_elems = NULL; // (abt_md.FDispatch.c_dispatch_msg)
    parent.c_dispatch_msg_n = 0; // (abt_md.FDispatch.c_dispatch_msg)
    parent.c_dispatch_msg_max = 0; // (abt_md.FDispatch.c_dispatch_msg)
    parent.ns_c_dispatch_in_ary = bool(false);
    parent.ind_dispatch_next = (abt_md::FDispatch*)-1; // (abt_md.FDb.ind_dispatch) not-in-hash
    parent.ind_dispatch_hashval = 0; // stored hash value
}

// --- abt_md.FDispatch..Uninit
void abt_md::FDispatch_Uninit(abt_md::FDispatch& parent) {
    ind_dispatch_Remove(parent); // remove dispatch from index ind_dispatch
    abt_md::FNs* p_ns = abt_md::ind_ns_Find(ns_Get(parent));
    if (p_ns)  {
        c_dispatch_Remove(*p_ns, parent);// remove dispatch from index c_dispatch
    }

    // abt_md.FDispatch.c_dispatch_msg.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_dispatch_msg_elems, sizeof(abt_md::FDispatchMsg*)*parent.c_dispatch_msg_max); // (abt_md.FDispatch.c_dispatch_msg)
}

// --- abt_md.FDispatchMsg.base.CopyOut
// Copy fields out of row
void abt_md::dispatch_msg_CopyOut(abt_md::FDispatchMsg &row, dmmeta::DispatchMsg &out) {
    out.dispatch_msg = row.dispatch_msg;
    out.comment = algo::Comment(row.comment);
}

// --- abt_md.FDispatchMsg.base.CopyIn
// Copy fields in to row
void abt_md::dispatch_msg_CopyIn(abt_md::FDispatchMsg &row, dmmeta::DispatchMsg &in) {
    row.dispatch_msg = in.dispatch_msg;
    row.comment = in.comment;
}

// --- abt_md.FDispatchMsg.dispatch.Get
algo::strptr abt_md::dispatch_Get(abt_md::FDispatchMsg& parent) {
    return algo::Pathcomp(parent.dispatch_msg, "/RL");
}

// --- abt_md.FDispatchMsg.ctype.Get
algo::strptr abt_md::ctype_Get(abt_md::FDispatchMsg& parent) {
    return algo::Pathcomp(parent.dispatch_msg, "/RR");
}

// --- abt_md.FDispatchMsg..Uninit
void abt_md::FDispatchMsg_Uninit(abt_md::FDispatchMsg& parent) {
    abt_md::FDispatch* p_dispatch = abt_md::ind_dispatch_Find(dispatch_Get(parent));
    if (p_dispatch)  {
...
algo::strptr abt_md::field_Get(abt_md::FFconst& parent) {
    return algo::Pathcomp(parent.fconst, "/LL");
}

// --- abt_md.FFconst.name.Get
algo::strptr abt_md::name_Get(abt_md::FFconst& parent) {
    return algo::Pathcomp(parent.fconst, "/LR");
}

// --- abt_md.FFconst..Uninit
void abt_md::FFconst_Uninit(abt_md::FFconst& parent) {
    abt_md::FField* p_field = abt_md::ind_field_Find(field_Get(parent));
    if (p_field)  {
...
algo::strptr abt_md::ctype_Get(abt_md::FField& parent) {
    return algo::Pathcomp(parent.field, ".RL");
}

// --- abt_md.FField.ns.Get
algo::strptr abt_md::ns_Get(abt_md::FField& parent) {
    return algo::Pathcomp(parent.field, ".RL.RL");
}

// --- abt_md.FField.name.Get
algo::strptr abt_md::name_Get(abt_md::FField& parent) {
...
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_fconst_Insert(abt_md::FField& parent, abt_md::FFconst& row) {
...
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_fconst_InsertMaybe(abt_md::FField& parent, abt_md::FFconst& row) {
...
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_fconst_Remove(abt_md::FField& parent, abt_md::FFconst& row) {
    i64 n = parent.c_fconst_n;
    if (bool_Update(row.field_c_fconst_in_ary,false)) {
        abt_md::FFconst* *elems = parent.c_fconst_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            ...
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FFconst*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
...
// Reserve space in index for N more elements;
void abt_md::c_fconst_Reserve(abt_md::FField& parent, u64 n) {
    ...
    if (UNLIKELY(parent.c_fconst_n + n > old_max)) {
        ...
        u64 old_size = old_max * sizeof(abt_md::FFconst*);
        u64 new_size = new_max * sizeof(abt_md::FFconst*);
        ...
        parent.c_fconst_elems = (abt_md::FFconst**)new_mem;
...
// --- abt_md.FField..Init
// Set all fields to initial values.
void abt_md::FField_Init(abt_md::FField& parent) {
    parent.reftype = algo::strptr("Val");
    parent.c_substr = NULL;
    parent.p_arg = NULL;
    parent.p_ctype = NULL;
    parent.ispkey = bool(false);
    parent.c_fconst_elems = NULL; // (abt_md.FField.c_fconst)
    parent.c_fconst_n = 0; // (abt_md.FField.c_fconst)
    parent.c_fconst_max = 0; // (abt_md.FField.c_fconst)
    parent.c_gconst = NULL;
    parent.ctype_c_field_in_ary = bool(false);
    parent.ctype_c_field_arg_in_ary = bool(false);
    parent.ind_field_next = (abt_md::FField*)-1; // (abt_md.FDb.ind_field) not-in-hash
    parent.ind_field_hashval = 0; // stored hash value
}

// --- abt_md.FField..Uninit
void abt_md::FField_Uninit(abt_md::FField& parent) {
    ind_field_Remove(parent); // remove field from index ind_field
    abt_md::FCtype* p_ctype = abt_md::ind_ctype_Find(ctype_Get(parent));
    if (p_ctype)  {
        c_field_Remove(*p_ctype, parent);// remove field from index c_field
    }
    abt_md::FCtype* p_arg = abt_md::ind_ctype_Find(parent.arg);
    if (p_arg)  {
        c_field_arg_Remove(*p_arg, parent);// remove field from index c_field_arg
    }

    // abt_md.FField.c_fconst.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_fconst_elems, sizeof(abt_md::FFconst*)*parent.c_fconst_max); // (abt_md.FField.c_fconst)
}

// --- abt_md.FFileSection..Uninit
void abt_md::FFileSection_Uninit(abt_md::FFileSection& parent) {
    bh_file_section_Remove(parent); // remove file_section from index bh_file_section
    abt_md::FMdsection* p_p_mdsection = parent.p_mdsection;
    if (p_p_mdsection)  {
        zd_file_section_Remove(*p_p_mdsection, parent);// remove file_section from index zd_file_section
    }
}

// --- abt_md.FFinput.base.CopyOut
// Copy fields out of row
void abt_md::finput_CopyOut(abt_md::FFinput &row, dmmeta::Finput &out) {
    out.field = row.field;
...
// --- abt_md.FFinput.base.CopyIn
// Copy fields in to row
void abt_md::finput_CopyIn(abt_md::FFinput &row, dmmeta::Finput &in) {
    row.field = in.field;
...
// --- abt_md.FFinput.ns.Get
algo::strptr abt_md::ns_Get(abt_md::FFinput& parent) {
    return algo::Pathcomp(parent.field, ".LL");
}

// --- abt_md.FFinput..Uninit
void abt_md::FFinput_Uninit(abt_md::FFinput& parent) {
    abt_md::FNs* p_ns = abt_md::ind_ns_Find(ns_Get(parent));
    if (p_ns)  {
        zd_finput_Remove(*p_ns, parent);// remove finput from index zd_finput
    }
}
...
algo::strptr abt_md::namefldctyp_Get(abt_md::FGconst& parent) {
    return algo::Pathcomp(parent.namefld, ".RL");
}

// --- abt_md.FGconst..Uninit
void abt_md::FGconst_Uninit(abt_md::FGconst& parent) {
    abt_md::FField* p_field = abt_md::ind_field_Find(parent.field);
    if (p_field)  {
        c_gconst_Remove(*p_field, parent);// remove gconst from index c_gconst
    }
}

// --- abt_md.FGitfile.base.CopyOut
// Copy fields out of row
void abt_md::gitfile_CopyOut(abt_md::FGitfile &row, dev::Gitfile &out) {
    out.gitfile = row.gitfile;
}

// --- abt_md.FGitfile.base.CopyIn
// Copy fields in to row
void abt_md::gitfile_CopyIn(abt_md::FGitfile &row, dev::Gitfile &in) {
    row.gitfile = in.gitfile;
}

// --- abt_md.FGitfile.ext.Get
algo::strptr abt_md::ext_Get(abt_md::FGitfile& parent) {
    return algo::Pathcomp(parent.gitfile, "/RR.LR.RR");
}

// --- abt_md.FGitfile..Uninit
void abt_md::FGitfile_Uninit(abt_md::FGitfile& parent) {
    ind_gitfile_Remove(parent); // remove gitfile from index ind_gitfile
}

// --- abt_md.FGstatic.base.CopyOut
// Copy fields out of row
void abt_md::gstatic_CopyOut(abt_md::FGstatic &row, dmmeta::Gstatic &out) {
    out.field = row.field;
    out.comment = algo::Comment(row.comment);
}

// --- abt_md.FGstatic.base.CopyIn
// Copy fields in to row
void abt_md::gstatic_CopyIn(abt_md::FGstatic &row, dmmeta::Gstatic &in) {
    row.field = in.field;
    row.comment = in.comment;
}

// --- abt_md.FGstatic.ns.Get
algo::strptr abt_md::ns_Get(abt_md::FGstatic& parent) {
    return algo::Pathcomp(parent.field, ".LL");
}

// --- abt_md.FGstatic..Uninit
void abt_md::FGstatic_Uninit(abt_md::FGstatic& parent) {
    ind_gstatic_Remove(parent); // remove gstatic from index ind_gstatic
}

// --- abt_md.FHumanText..Uninit
void abt_md::FHumanText_Uninit(abt_md::FHumanText& parent) {
    ind_human_text_Remove(parent); // remove human_text from index ind_human_text
}
...
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_targsrc_Insert(abt_md::FNs& parent, abt_md::FTargsrc& row) {
    if (!row.ns_c_targsrc_in_ary) {
        c_targsrc_Reserve(parent, 1);
        u64 n  = parent.c_targsrc_n++;
        parent.c_targsrc_elems[n] = &row;
        row.ns_c_targsrc_in_ary = true;
    }
}
...
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_targsrc_InsertMaybe(abt_md::FNs& parent, abt_md::FTargsrc& row) {
    bool retval = !ns_c_targsrc_InAryQ(row);
...
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_targsrc_Remove(abt_md::FNs& parent, abt_md::FTargsrc& row) {
    i64 n = parent.c_targsrc_n;
    if (bool_Update(row.ns_c_targsrc_in_ary,false)) {
        abt_md::FTargsrc* *elems = parent.c_targsrc_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            ...
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FTargsrc*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
...
// Reserve space in index for N more elements;
void abt_md::c_targsrc_Reserve(abt_md::FNs& parent, u64 n) {
    ...
    if (UNLIKELY(parent.c_targsrc_n + n > old_max)) {
        ...
        u64 old_size = old_max * sizeof(abt_md::FTargsrc*);
        u64 new_size = new_max * sizeof(abt_md::FTargsrc*);
        ...
        parent.c_targsrc_elems = (abt_md::FTargsrc**)new_mem;
...
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_ctype_Insert(abt_md::FNs& parent, abt_md::FCtype& row) {
...
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_ctype_InsertMaybe(abt_md::FNs& parent, abt_md::FCtype& row) {
    bool retval = !ns_c_ctype_InAryQ(row);
    c_ctype_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FNs.c_ctype.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_ctype_Remove(abt_md::FNs& parent, abt_md::FCtype& row) {
    i64 n = parent.c_ctype_n;
    if (bool_Update(row.ns_c_ctype_in_ary,false)) {
        abt_md::FCtype* *elems = parent.c_ctype_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            ...
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FCtype*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
                parent.c_ctype_n = n - 1;
                break;
            }
        }
    }
...
// Reserve space in index for N more elements;
void abt_md::c_ctype_Reserve(abt_md::FNs& parent, u64 n) {
    ...
    if (UNLIKELY(parent.c_ctype_n + n > old_max)) {
        ...
        u64 old_size = old_max * sizeof(abt_md::FCtype*);
        u64 new_size = new_max * sizeof(abt_md::FCtype*);
        ...
        parent.c_ctype_elems = (abt_md::FCtype**)new_mem;
...
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_comptest_Insert(abt_md::FNs& parent, abt_md::FComptest& row) {
    if (!row.ns_c_comptest_in_ary) {
        c_comptest_Reserve(parent, 1);
        u64 n  = parent.c_comptest_n++;
        parent.c_comptest_elems[n] = &row;
        row.ns_c_comptest_in_ary = true;
    }
}
...
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_comptest_InsertMaybe(abt_md::FNs& parent, abt_md::FComptest& row) {
    bool retval = !ns_c_comptest_InAryQ(row);
    c_comptest_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FNs.c_comptest.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_comptest_Remove(abt_md::FNs& parent, abt_md::FComptest& row) {
    i64 n = parent.c_comptest_n;
    if (bool_Update(row.ns_c_comptest_in_ary,false)) {
        abt_md::FComptest* *elems = parent.c_comptest_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            ...
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FComptest*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
                parent.c_comptest_n = n - 1;
                break;
            }
        }
    }
...
// Reserve space in index for N more elements;
void abt_md::c_comptest_Reserve(abt_md::FNs& parent, u64 n) {
    u64 old_max = parent.c_comptest_max;
    if (UNLIKELY(parent.c_comptest_n + n > old_max)) {
        u64 new_max  = u64_Max(u64_Max(old_max * 2, parent.c_comptest_n + n), 4);
        u64 old_size = old_max * sizeof(abt_md::FComptest*);
        u64 new_size = new_max * sizeof(abt_md::FComptest*);
        void *new_mem = algo_lib::malloc_ReallocMem(parent.c_comptest_elems, old_size, new_size);
        if (UNLIKELY(!new_mem)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FNs.c_comptest");
        }
        parent.c_comptest_elems = (abt_md::FComptest**)new_mem;
        parent.c_comptest_max = new_max;
    }
}

// --- abt_md.FNs.zd_finput.Insert
// Insert row into linked list. If row is already in linked list, do nothing.
void abt_md::zd_finput_Insert(abt_md::FNs& parent, abt_md::FFinput& row) {
    if (!ns_zd_finput_InLlistQ(row)) {
        abt_md::FFinput* old_tail = parent.zd_finput_tail;
        row.ns_zd_finput_next = NULL;
        row.ns_zd_finput_prev = old_tail;
        parent.zd_finput_tail = &row;
        abt_md::FFinput **new_row_a = &old_tail->ns_zd_finput_next;
        abt_md::FFinput **new_row_b = &parent.zd_finput_head;
        abt_md::FFinput **new_row = old_tail ? new_row_a : new_row_b;
        *new_row = &row;
        parent.zd_finput_n++;
    }
}

// --- abt_md.FNs.zd_finput.Remove
// Remove element from index. If element is not in index, do nothing.
void abt_md::zd_finput_Remove(abt_md::FNs& parent, abt_md::FFinput& row) {
    if (ns_zd_finput_InLlistQ(row)) {
        abt_md::FFinput* old_head       = parent.zd_finput_head;
        (void)old_head; // in case it's not used
        abt_md::FFinput* prev = row.ns_zd_finput_prev;
        abt_md::FFinput* next = row.ns_zd_finput_next;
        // if element is first, adjust list head; otherwise, adjust previous element's next
        abt_md::FFinput **new_next_a = &prev->ns_zd_finput_next;
        abt_md::FFinput **new_next_b = &parent.zd_finput_head;
        abt_md::FFinput **new_next = prev ? new_next_a : new_next_b;
        *new_next = next;
        // if element is last, adjust list tail; otherwise, adjust next element's prev
        abt_md::FFinput **new_prev_a = &next->ns_zd_finput_prev;
        abt_md::FFinput **new_prev_b = &parent.zd_finput_tail;
        abt_md::FFinput **new_prev = next ? new_prev_a : new_prev_b;
        *new_prev = prev;
        parent.zd_finput_n--;
        row.ns_zd_finput_next=(abt_md::FFinput*)-1; // not-in-list
    }
}

// --- abt_md.FNs.zd_finput.RemoveAll
// Empty the index. (The rows are not deleted)
void abt_md::zd_finput_RemoveAll(abt_md::FNs& parent) {
    abt_md::FFinput* row = parent.zd_finput_head;
    parent.zd_finput_head = NULL;
    parent.zd_finput_tail = NULL;
    parent.zd_finput_n = 0;
    while (row) {
        abt_md::FFinput* row_next = row->ns_zd_finput_next;
        row->ns_zd_finput_next  = (abt_md::FFinput*)-1;
        row->ns_zd_finput_prev  = NULL;
        row = row_next;
    }
}

// --- abt_md.FNs.zd_finput.RemoveFirst
// If linked list is empty, return NULL. Otherwise unlink and return pointer to first element.
abt_md::FFinput* abt_md::zd_finput_RemoveFirst(abt_md::FNs& parent) {
    abt_md::FFinput *row = NULL;
    row = parent.zd_finput_head;
    if (row) {
        abt_md::FFinput *next = row->ns_zd_finput_next;
        parent.zd_finput_head = next;
        abt_md::FFinput **new_end_a = &next->ns_zd_finput_prev;
        abt_md::FFinput **new_end_b = &parent.zd_finput_tail;
        abt_md::FFinput **new_end = next ? new_end_a : new_end_b;
        *new_end = NULL;
        parent.zd_finput_n--;
        row->ns_zd_finput_next = (abt_md::FFinput*)-1; // mark as not-in-list
    }
    return row;
}

// --- abt_md.FNs.zd_finput.InsertBefore
// Insert row before given element, or at tail when before is NULL; no-op if row is already in list.
void abt_md::zd_finput_InsertBefore(abt_md::FNs& parent, abt_md::FFinput& row, abt_md::FFinput* before) {
    if (!ns_zd_finput_InLlistQ(row) && &row != before) {
        abt_md::FFinput* next = before;
        abt_md::FFinput* prev = next ? next->ns_zd_finput_prev : parent.zd_finput_tail;
        row.ns_zd_finput_next = next;
        row.ns_zd_finput_prev = prev;
        abt_md::FFinput **prev_link_a = &prev->ns_zd_finput_next;
        abt_md::FFinput **prev_link_b = &parent.zd_finput_head;
        *(prev ? prev_link_a : prev_link_b) = &row;
        abt_md::FFinput **next_link_a = &next->ns_zd_finput_prev;
        abt_md::FFinput **next_link_b = &parent.zd_finput_tail;
        *(next ? next_link_a : next_link_b) = &row;
        parent.zd_finput_n++;
    }
}

// --- abt_md.FNs.c_dispatch.Insert
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_dispatch_Insert(abt_md::FNs& parent, abt_md::FDispatch& row) {
    if (!row.ns_c_dispatch_in_ary) {
        c_dispatch_Reserve(parent, 1);
        u64 n  = parent.c_dispatch_n++;
        parent.c_dispatch_elems[n] = &row;
        row.ns_c_dispatch_in_ary = true;
    }
}

// --- abt_md.FNs.c_dispatch.InsertMaybe
// Insert pointer to row in array.
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_dispatch_InsertMaybe(abt_md::FNs& parent, abt_md::FDispatch& row) {
    bool retval = !ns_c_dispatch_InAryQ(row);
    c_dispatch_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FNs.c_dispatch.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_dispatch_Remove(abt_md::FNs& parent, abt_md::FDispatch& row) {
    i64 n = parent.c_dispatch_n;
    if (bool_Update(row.ns_c_dispatch_in_ary,false)) {
        abt_md::FDispatch* *elems = parent.c_dispatch_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            abt_md::FDispatch* elem = elems[i]; // fetch element
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FDispatch*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
                parent.c_dispatch_n = n - 1;
                break;
            }
        }
    }
...
// --- abt_md.FNs.c_dispatch.Reserve
// Reserve space in index for N more elements;
void abt_md::c_dispatch_Reserve(abt_md::FNs& parent, u64 n) {
    u64 old_max = parent.c_dispatch_max;
    if (UNLIKELY(parent.c_dispatch_n + n > old_max)) {
        u64 new_max  = u64_Max(u64_Max(old_max * 2, parent.c_dispatch_n + n), 4);
        u64 old_size = old_max * sizeof(abt_md::FDispatch*);
        u64 new_size = new_max * sizeof(abt_md::FDispatch*);
        void *new_mem = algo_lib::malloc_ReallocMem(parent.c_dispatch_elems, old_size, new_size);
        if (UNLIKELY(!new_mem)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FNs.c_dispatch");
        }
        parent.c_dispatch_elems = (abt_md::FDispatch**)new_mem;
        parent.c_dispatch_max = new_max;
    }
}

// --- abt_md.FNs..Init
// Set all fields to initial values.
void abt_md::FNs_Init(abt_md::FNs& parent) {
    parent.c_readmefile = NULL;
    parent.c_targsrc_elems = NULL; // (abt_md.FNs.c_targsrc)
    parent.c_targsrc_n = 0; // (abt_md.FNs.c_targsrc)
    parent.c_targsrc_max = 0; // (abt_md.FNs.c_targsrc)
    parent.c_ctype_elems = NULL; // (abt_md.FNs.c_ctype)
    parent.c_ctype_n = 0; // (abt_md.FNs.c_ctype)
    parent.c_ctype_max = 0; // (abt_md.FNs.c_ctype)
    parent.c_comptest_elems = NULL; // (abt_md.FNs.c_comptest)
    parent.c_comptest_n = 0; // (abt_md.FNs.c_comptest)
    parent.c_comptest_max = 0; // (abt_md.FNs.c_comptest)
    parent.c_target = NULL;
    parent.zd_finput_head = NULL; // (abt_md.FNs.zd_finput)
    parent.zd_finput_n = 0; // (abt_md.FNs.zd_finput)
    parent.zd_finput_tail = NULL; // (abt_md.FNs.zd_finput)
    parent.c_dispatch_elems = NULL; // (abt_md.FNs.c_dispatch)
    parent.c_dispatch_n = 0; // (abt_md.FNs.c_dispatch)
...
void abt_md::FNs_Uninit(abt_md::FNs& parent) {
    ...
    algo_lib::malloc_FreeMem(parent.c_comptest_elems, sizeof(abt_md::FComptest*)*parent.c_comptest_max); // (abt_md.FNs.c_comptest)

    // abt_md.FNs.c_ctype.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_ctype_elems, sizeof(abt_md::FCtype*)*parent.c_ctype_max); // (abt_md.FNs.c_ctype)

    // abt_md.FNs.c_targsrc.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_targsrc_elems, sizeof(abt_md::FTargsrc*)*parent.c_targsrc_max); // (abt_md.FNs.c_targsrc)
}
...
void abt_md::FNstype_Uninit(abt_md::FNstype& parent) {
    ind_nstype_Remove(parent); // remove nstype from index ind_nstype
}

// --- abt_md.FReadmefile.base.CopyOut
// Copy fields out of row
void abt_md::readmefile_CopyOut(abt_md::FReadmefile &row, dev::Readmefile &out) {
    out.gitfile = row.gitfile;
    out.inl = row.inl;
...
// --- abt_md.FReadmefile.base.CopyIn
// Copy fields in to row
void abt_md::readmefile_CopyIn(abt_md::FReadmefile &row, dev::Readmefile &in) {
    row.gitfile = in.gitfile;
    row.inl = in.inl;
...
// --- abt_md.FReadmefile..Init
// Set all fields to initial values.
void abt_md::FReadmefile_Init(abt_md::FReadmefile& parent) {
    parent.inl = bool(false);
    parent.sandbox = bool(false);
    parent.p_ns = NULL;
    parent.p_ssimfile = NULL;
    parent.p_ctype = NULL;
    parent.p_scriptfile = NULL;
    parent.select = bool(false);
    parent.ind_readmefile_next = (abt_md::FReadmefile*)-1; // (abt_md.FDb.ind_readmefile) not-in-hash
...
// Set all fields to initial values.
void abt_md::FReftype_Init(abt_md::FReftype& parent) {
    parent.reftype = algo::strptr("Val");
...
algo::strptr abt_md::name_Get(abt_md::FScriptfile& parent) {
    return algo::Pathcomp(parent.gitfile, "/RR");
}

// --- abt_md.FScriptfile..Uninit
void abt_md::FScriptfile_Uninit(abt_md::FScriptfile& parent) {
...
algo::strptr abt_md::ssimns_Get(abt_md::FSsimfile& parent) {
    return algo::Pathcomp(parent.ssimfile, ".LL");
}

// --- abt_md.FSsimfile.ns.Get
algo::strptr abt_md::ns_Get(abt_md::FSsimfile& parent) {
    return algo::Pathcomp(parent.ssimfile, ".LL");
}

// --- abt_md.FSsimfile.name.Get
algo::strptr abt_md::name_Get(abt_md::FSsimfile& parent) {
    return algo::Pathcomp(parent.ssimfile, ".RR");
}

// --- abt_md.FSsimfile..Uninit
void abt_md::FSsimfile_Uninit(abt_md::FSsimfile& parent) {
    ind_ssimfile_Remove(parent); // remove ssimfile from index ind_ssimfile
    abt_md::FCtype* p_ctype = abt_md::ind_ctype_Find(parent.ctype);
    if (p_ctype)  {
...
void abt_md::FSubstr_Uninit(abt_md::FSubstr& parent) {
    abt_md::FField* p_field = abt_md::ind_field_Find(parent.field);
    if (p_field)  {
...
// --- abt_md.FTargdep.base.CopyOut
// Copy fields out of row
void abt_md::targdep_CopyOut(abt_md::FTargdep &row, dev::Targdep &out) {
    out.targdep = row.targdep;
    out.comment = algo::Comment(row.comment);
}

// --- abt_md.FTargdep.base.CopyIn
// Copy fields in to row
void abt_md::targdep_CopyIn(abt_md::FTargdep &row, dev::Targdep &in) {
    row.targdep = in.targdep;
    row.comment = in.comment;
}

// --- abt_md.FTargdep.target.Get
algo::strptr abt_md::target_Get(abt_md::FTargdep& parent) {
    return algo::Pathcomp(parent.targdep, ".RL");
}

// --- abt_md.FTargdep.parent.Get
algo::strptr abt_md::parent_Get(abt_md::FTargdep& parent) {
    return algo::Pathcomp(parent.targdep, ".RR");
}

// --- abt_md.FTargdep..Uninit
void abt_md::FTargdep_Uninit(abt_md::FTargdep& parent) {
    abt_md::FTarget* p_target = abt_md::ind_target_Find(target_Get(parent));
    if (p_target)  {
        c_targdep_Remove(*p_target, parent);// remove targdep from index c_targdep
    }
}

// --- abt_md.FTarget.base.CopyOut
// Copy fields out of row
void abt_md::target_CopyOut(abt_md::FTarget &row, dev::Target &out) {
    out.target = row.target;
}

// --- abt_md.FTarget.base.CopyIn
// Copy fields in to row
void abt_md::target_CopyIn(abt_md::FTarget &row, dev::Target &in) {
    row.target = in.target;
}

// --- abt_md.FTarget.c_targdep.Insert
// Insert pointer to row into array. Row must not already be in array;
// no duplicate check is performed, so a duplicate insert silently appears twice.
void abt_md::c_targdep_Insert(abt_md::FTarget& parent, abt_md::FTargdep& row) {
...
// --- abt_md.FTarget.c_targdep.InsertMaybe
// Insert pointer to row in array.
// If row is already in the array, do nothing.
// Return value: whether element was inserted into array.
bool abt_md::c_targdep_InsertMaybe(abt_md::FTarget& parent, abt_md::FTargdep& row) {
    bool retval = !target_c_targdep_InAryQ(row);
    c_targdep_Insert(parent,row); // check is performed in _Insert again
    return retval;
}

// --- abt_md.FTarget.c_targdep.Remove
// Find element using linear scan. If element is in array, remove, otherwise do nothing
void abt_md::c_targdep_Remove(abt_md::FTarget& parent, abt_md::FTargdep& row) {
    i64 n = parent.c_targdep_n;
    if (bool_Update(row.target_c_targdep_in_ary,false)) {
        abt_md::FTargdep* *elems = parent.c_targdep_elems;
        // search backward, so that most recently added element is found first.
        // if found, shift array.
        for (i64 i = n-1; i>=0; i--) {
            abt_md::FTargdep* elem = elems[i]; // fetch element
            if (elem == &row) {
                i64 j = i + 1;
                size_t nbytes = sizeof(abt_md::FTargdep*) * (n - j);
                memmove(elems + i, elems + j, nbytes);
...
// --- abt_md.FTarget.c_targdep.Reserve
// Reserve space in index for N more elements;
void abt_md::c_targdep_Reserve(abt_md::FTarget& parent, u64 n) {
    ...
    if (UNLIKELY(parent.c_targdep_n + n > old_max)) {
        ...
        u64 old_size = old_max * sizeof(abt_md::FTargdep*);
        u64 new_size = new_max * sizeof(abt_md::FTargdep*);
        void *new_mem = algo_lib::malloc_ReallocMem(parent.c_targdep_elems, old_size, new_size);
        if (UNLIKELY(!new_mem)) {
            FatalErrorExit("abt_md.out_of_memory  field:abt_md.FTarget.c_targdep");
        }
        parent.c_targdep_elems = (abt_md::FTargdep**)new_mem;
        parent.c_targdep_max = new_max;
    }
}

// --- abt_md.FTarget..Uninit
void abt_md::FTarget_Uninit(abt_md::FTarget& parent) {
    abt_md::FNs* p_target = abt_md::ind_ns_Find(parent.target);
    if (p_target)  {
    ...
    // abt_md.FTarget.c_targdep.Uninit (Ptrary)  //
    algo_lib::malloc_FreeMem(parent.c_targdep_elems, sizeof(abt_md::FTargdep*)*parent.c_targdep_max); // (abt_md.FTarget.c_targdep)
}
...
algo::strptr abt_md::target_Get(abt_md::FTargsrc& parent) {
    return algo::Pathcomp(parent.targsrc, "/LL");
}

// --- abt_md.FTargsrc.src.Get
algo::strptr abt_md::src_Get(abt_md::FTargsrc& parent) {
    return algo::Pathcomp(parent.targsrc, "/LR");
}

// --- abt_md.FTargsrc.ext.Get
algo::strptr abt_md::ext_Get(abt_md::FTargsrc& parent) {
    return algo::Pathcomp(parent.targsrc, ".RR");
}

// --- abt_md.FTargsrc..Uninit
void abt_md::FTargsrc_Uninit(abt_md::FTargsrc& parent) {
    abt_md::FNs* p_target = abt_md::ind_ns_Find(target_Get(parent));
    if (p_target)  {
...
void abt_md::FTclass_Uninit(abt_md::FTclass& parent) {
    ind_tclass_Remove(parent); // remove tclass from index ind_tclass
}
...
const char* abt_md::value_ToCstr(const abt_md::TableId& parent) {
    ...
    switch(value_GetEnum(parent)) {
        ...
        case abt_md_TableId_dmmeta_Dispatch: ret = "dmmeta.Dispatch";  break;
        case abt_md_TableId_dmmeta_DispatchMsg: ret = "dmmeta.DispatchMsg";  break;
        case abt_md_TableId_dmmeta_Fconst  : ret = "dmmeta.Fconst";  break;
        case abt_md_TableId_dmmeta_Field   : ret = "dmmeta.Field";  break;
        case abt_md_TableId_dmmeta_Finput  : ret = "dmmeta.Finput";  break;
        case abt_md_TableId_dmmeta_Gconst  : ret = "dmmeta.Gconst";  break;
        case abt_md_TableId_dev_Gitfile    : ret = "dev.Gitfile";  break;
        case abt_md_TableId_dmmeta_Gstatic : ret = "dmmeta.Gstatic";  break;
        ...
        case abt_md_TableId_dev_Targdep    : ret = "dev.Targdep";  break;
        case abt_md_TableId_dev_Target     : ret = "dev.Target";  break;
    ...
    switch (elems_N(rhs)) {
        ...
        case 10: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','e','v','.','T','a','r','g'): {
                    if (memcmp(rhs.elems+8,"et",2)==0) { value_SetEnum(parent,abt_md_TableId_dev_Target); ret = true; break; }
                    break;
                }
                case LE_STR8('d','e','v','.','t','a','r','g'): {
                    if (memcmp(rhs.elems+8,"et",2)==0) { value_SetEnum(parent,abt_md_TableId_dev_target); ret = true; break; }
        ...
        case 11: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','e','v','.','G','i','t','f'): {
                    if (memcmp(rhs.elems+8,"ile",3)==0) { value_SetEnum(parent,abt_md_TableId_dev_Gitfile); ret = true; break; }
                    break;
                }
                case LE_STR8('d','e','v','.','T','a','r','g'): {
                    if (memcmp(rhs.elems+8,"dep",3)==0) { value_SetEnum(parent,abt_md_TableId_dev_Targdep); ret = true; break; }
        ...
        case 13: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','m','m','e','t','a','.','F'): {
                    ...
                    if (memcmp(rhs.elems+8,"input",5)==0) { value_SetEnum(parent,abt_md_TableId_dmmeta_Finput); ret = true; break; }
                    break;
                }
        ...
        case 14: {
            switch (algo::ReadLE64(rhs.elems)) {
                ...
                case LE_STR8('d','m','m','e','t','a','.','G'): {
                    if (memcmp(rhs.elems+8,"static",6)==0) { value_SetEnum(parent,abt_md_TableId_dmmeta_Gstatic); ret = true; break; }
                    break;
                }
        ...
        case 15: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','m','m','e','t','a','.','D'): {
                    if (memcmp(rhs.elems+8,"ispatch",7)==0) { value_SetEnum(parent,abt_md_TableId_dmmeta_Dispatch); ret = true; break; }
                    break;
                }
                case LE_STR8('d','m','m','e','t','a','.','S'): {
        ...
        case 18: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','m','m','e','t','a','.','D'): {
                    if (memcmp(rhs.elems+8,"ispatchMsg",10)==0) { value_SetEnum(parent,abt_md_TableId_dmmeta_DispatchMsg); ret = true; break; }
                    break;
                }
            }
            break;
        ...
        case 19: {
            switch (algo::ReadLE64(rhs.elems)) {
                case LE_STR8('d','m','m','e','t','a','.','d'): {
                    if (memcmp(rhs.elems+8,"ispatch_msg",11)==0) { value_SetEnum(parent,abt_md_TableId_dmmeta_dispatch_msg); ret = true; break; }
                    break;
                }
            }
            break;
