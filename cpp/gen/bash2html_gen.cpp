...
void bash2html::ReadArgv() {
    ...
    command::bash2html_ReadArgv(cmd, args, err);
    bool dohelp = false;
    bool doexit=false;
    ...
    // dmmeta.floadtuples:command.bash2html.in
    if (!dohelp && err=="") {
...
static void bash2html::InitReflection() {
    ...
    row.Step               = NULL;
    row.MainLoop           = bash2html::MainLoop;
...
// --- bash2html.FDb._db.RemoveStrptrMaybe
// Parse strptr into known type and remove matching record from database.
// Return value is true if the record was found and removed, false otherwise.
bool bash2html::RemoveStrptrMaybe(algo::strptr str) {
    bool retval = true;
    (void)str;//only to avoid -Wunused-parameter
    return retval;
}
