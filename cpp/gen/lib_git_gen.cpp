...
bool lib_git::LoadTuplesMaybe(algo::strptr root) {
    bool retval = true;
...
bool lib_git::LoadSsimfileMaybe(algo::strptr fname) {
    bool retval = true;
    if (FileQ(fname)) {
        retval = algo_lib::LoadTuplesFile(fname, lib_git::InsertStrptrMaybe, true);
    }
    return retval;
}
...
bool lib_git::FieldId_ReadStrptrMaybe(lib_git::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && lib_git::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
