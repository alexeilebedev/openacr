...
"    -data_dir   string  Load dmmeta info from this directory. default: \"data\"\n"
"    -maxpacket  int     Max Mysql packet size. default: 100000\n"
"    -replace            use REPLACE INTO instead of INSERT INTO. default: true\n"
"    -trunc              Truncate target table. default: false\n"
"    -dry_run            Print SQL commands to the stdout. default: false\n"
"    -fldfunc            create columns for fldfuncs. default: false\n"
"    -in         string  Input directory or filename, - for stdin. default: \"-\"\n"
"    -db         string  Optional database name\n"
"    -createdb           Emit CREATE DATABASE code for namespace specified with <db>. default: false\n"
"    -fkey               Enable foreign key constraints (uses InnoDB storage engine). default: false\n"
...
const char *ssim2mysql_syntax =
"-url:string=\n"
" -data_dir:string=\"data\"\n"
" -maxpacket:int=100000\n"
" -replace:flag=true\n"
" -trunc:flag\n"
" -dry_run:flag\n"
" -fldfunc:flag\n"
...
static bool ssim2mysql::sqltype_InputMaybe(dmmeta::Sqltype &elem) {
    bool retval = true;
    retval = sqltype_InsertMaybe(elem);
    return retval;
}
...
// --- ssim2mysql.FDb._db.MainArgs
// Main function
void ssim2mysql::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,ssim2mysql_syntax, ssim2mysql_help);
    vrfy(ssim2mysql_ReadTupleMaybe(ssim2mysql::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(ssim2mysql::LoadTuplesMaybe(ssim2mysql::_db.cmdline.data_dir)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    ssim2mysql::Main(); // call through to user-defined main
}
...
bool ssim2mysql::FieldId_ReadStrptrMaybe(ssim2mysql::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && ssim2mysql::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
