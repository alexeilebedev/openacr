...
"Usage: src_func [options]\n"
"    -in           string  Input directory or filename, - for stdin. default: \"data\"\n"
"    [targsrc]     string  Visit these sources (accepts target name). default: \"%\"\n"
"    [name]        string  (with -listfunc) Match function name. default: \"%\"\n"
"    [body]        string  (with -listfunc) Match function body. default: \"%\"\n"
"    -func         string  (with -listfunc) Match function prototype. default: \"%\"\n"
"    -comment      string  (with -listfunc) Match function comment. default: \"%\"\n"
"    -nextfile     string  Print name of next srcfile in targsrc list\n"
"    -other                (with -nextfile), name of previous file. default: false\n"
...
"    -showstatic           (with -listfunc) Show static functions. default: true\n"
...
// --- src_func.FDb._db.MainArgs
// Main function
void src_func::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,src_func_syntax, src_func_help);
    vrfy(src_func_ReadTupleMaybe(src_func::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    vrfy(src_func::LoadTuplesMaybe(src_func::_db.cmdline.in)
    ,tempstr()<<"where:load_input  "<<algo_lib::DetachBadTags());
    src_func::Main(); // call through to user-defined main
}
...
bool src_func::FieldId_ReadStrptrMaybe(src_func::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && src_func::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
