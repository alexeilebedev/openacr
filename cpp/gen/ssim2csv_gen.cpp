...
// --- ssim2csv.FDb._db.MainArgs
// Main function
void ssim2csv::MainArgs(int argc, char **argv) {
    Argtuple argtuple;
    Argtuple_ReadArgv(argtuple, argc,argv,ssim2csv_syntax, ssim2csv_help);
    vrfy(ssim2csv_ReadTupleMaybe(ssim2csv::_db.cmdline, argtuple.tuple),"where:read_cmdline");
    ssim2csv::Main(); // call through to user-defined main
}
...
bool ssim2csv::FieldId_ReadStrptrMaybe(ssim2csv::FieldId &parent, algo::strptr in_str) {
    bool retval = true;
    retval = retval && ssim2csv::value_ReadStrptrMaybe(parent, in_str);
    return retval;
}
