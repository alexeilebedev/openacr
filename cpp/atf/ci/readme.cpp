...
void atf_ci::citest_inline_readme() {
    ind_beg(atf_ci::_db_readme_curs,readme,atf_ci::_db) {
        cstring out;
        bool inblock=false;
...
void atf_ci::citest_readme() {
    cstring text;
    cstring out;
    out << "This file was created with 'atf_ci readme' from files in [txt/](txt/) -- *do not edit*\n\n";
